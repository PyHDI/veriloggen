...
import veriloggen
import stream_reduceadd_validready
...
(
  ...
  always @(posedge CLK) begin
    if(RST) begin
      ...
      if(_ivalid_0 && _tmp_0 && (_count_5 == 0)) begin
      ...
      if(_ivalid_0 && _tmp_0 && (_count_8 == 0)) begin
        _data_8 <= _count_8 == 7;
      end 
    end
  end
...
def test():
    veriloggen.reset()
    test_module = stream_reduceadd_validready.mkTest()
