...
(
  ...
  always @(posedge CLK) begin
    if(RST) begin
      ...
      case(_d4_fsm)
        fsm_13: begin
          if(_fsm_cond_13_6_4 && (count >= 32)) begin
            valid <= 0;
          end 
        end
        fsm_14: begin
          if(_fsm_cond_14_10_4 && (count >= 32)) begin
            valid <= 0;
          end 
        end
        fsm_15: begin
          if(_fsm_cond_15_14_4 && (count >= 32)) begin
            valid <= 0;
          end 
        end
        fsm_16: begin
          if(_fsm_cond_16_18_4 && (count >= 32)) begin
            valid <= 0;
          end 
        end
        fsm_17: begin
          if(_fsm_cond_17_22_4 && (count >= 32)) begin
            valid <= 0;
          end 
        end
        fsm_18: begin
          if(_fsm_cond_18_26_4 && (count >= 32)) begin
            valid <= 0;
          end 
        end
        fsm_19: begin
          if(_fsm_cond_19_30_4 && (count >= 32)) begin
            valid <= 0;
          end 
        end
        fsm_20: begin
          if(_fsm_cond_20_34_4 && (count >= 32)) begin
            valid <= 0;
          end 
        end
      endcase
      case(_d3_fsm)
        fsm_4: begin
          if(_fsm_cond_4_2_3 && (count >= 16)) begin
            valid <= 0;
          end 
        end
        fsm_13: begin
          if(_fsm_cond_13_5_3 && (count >= 32)) begin
            valid <= 1;
          end 
          _fsm_cond_13_6_4 <= _fsm_cond_13_6_3;
        end
        fsm_14: begin
          if(_fsm_cond_14_9_3 && (count >= 32)) begin
            valid <= 1;
          end 
          _fsm_cond_14_10_4 <= _fsm_cond_14_10_3;
        end
        fsm_15: begin
          if(_fsm_cond_15_13_3 && (count >= 32)) begin
            valid <= 1;
          end 
          _fsm_cond_15_14_4 <= _fsm_cond_15_14_3;
        end
        fsm_16: begin
          if(_fsm_cond_16_17_3 && (count >= 32)) begin
            valid <= 1;
          end 
          _fsm_cond_16_18_4 <= _fsm_cond_16_18_3;
        end
        fsm_17: begin
          if(_fsm_cond_17_21_3 && (count >= 32)) begin
            valid <= 1;
          end 
          _fsm_cond_17_22_4 <= _fsm_cond_17_22_3;
        end
        fsm_18: begin
          if(_fsm_cond_18_25_3 && (count >= 32)) begin
            valid <= 1;
          end 
          _fsm_cond_18_26_4 <= _fsm_cond_18_26_3;
        end
        fsm_19: begin
          if(_fsm_cond_19_29_3 && (count >= 32)) begin
            valid <= 1;
          end 
          _fsm_cond_19_30_4 <= _fsm_cond_19_30_3;
        end
        fsm_20: begin
          if(_fsm_cond_20_33_3 && (count >= 32)) begin
            valid <= 1;
          end 
      ...
      case(_d2_fsm)
        fsm_4: begin
          if(_fsm_cond_4_1_2 && (count >= 16)) begin
            valid <= 1;
          end 
          _fsm_cond_4_2_3 <= _fsm_cond_4_2_2;
        end
        fsm_13: begin
          if(_fsm_cond_13_4_2 && (count >= 32)) begin
            valid <= 1;
          end 
        ...
        fsm_14: begin
          if(_fsm_cond_14_8_2 && (count >= 32)) begin
            valid <= 1;
          end 
        ...
        fsm_15: begin
          if(_fsm_cond_15_12_2 && (count >= 32)) begin
            valid <= 1;
          end 
        ...
        fsm_16: begin
          if(_fsm_cond_16_16_2 && (count >= 32)) begin
            valid <= 1;
          end 
        ...
        fsm_17: begin
          if(_fsm_cond_17_20_2 && (count >= 32)) begin
            valid <= 1;
          end 
        ...
        fsm_18: begin
          if(_fsm_cond_18_24_2 && (count >= 32)) begin
            valid <= 1;
          end 
        ...
        fsm_19: begin
          if(_fsm_cond_19_28_2 && (count >= 32)) begin
            valid <= 1;
          end 
        ...
        fsm_20: begin
          if(_fsm_cond_20_32_2 && (count >= 32)) begin
            valid <= 1;
          end 
      ...
      case(_d1_fsm)
        fsm_4: begin
          if(_fsm_cond_4_0_1 && (count >= 16)) begin
            valid <= 1;
          end 
        ...
        fsm_13: begin
          if(_fsm_cond_13_3_1 && (count >= 32)) begin
            valid <= 1;
          end 
        ...
        fsm_14: begin
          if(_fsm_cond_14_7_1 && (count >= 32)) begin
            valid <= 1;
          end 
        ...
        fsm_15: begin
          if(_fsm_cond_15_11_1 && (count >= 32)) begin
            valid <= 1;
          end 
        ...
        fsm_16: begin
          if(_fsm_cond_16_15_1 && (count >= 32)) begin
            valid <= 1;
          end 
        ...
        fsm_17: begin
          if(_fsm_cond_17_19_1 && (count >= 32)) begin
            valid <= 1;
          end 
        ...
        fsm_18: begin
          if(_fsm_cond_18_23_1 && (count >= 32)) begin
            valid <= 1;
          end 
        ...
        fsm_19: begin
          if(_fsm_cond_19_27_1 && (count >= 32)) begin
            valid <= 1;
          end 
        ...
        fsm_20: begin
          if(_fsm_cond_20_31_1 && (count >= 32)) begin
            valid <= 1;
          end 
...
def test():
    test_module = fsm_delayed_lazy_cond.mkTest()
