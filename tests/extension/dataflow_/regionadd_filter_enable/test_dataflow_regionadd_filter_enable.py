...
(
  ...
  reg _tmp_valid_26;
  wire _tmp_ready_26;
  assign _tmp_ready_24 = (_tmp_ready_26 || !_tmp_valid_26) && (_tmp_valid_25 && _tmp_valid_24);
  reg [1-1:0] _tmp_data_27;
  reg _tmp_valid_27;
  wire _tmp_ready_27;
  assign _tmp_ready_25 = (_tmp_ready_26 || !_tmp_valid_26) && (_tmp_valid_25 && _tmp_valid_24) && ((_tmp_ready_27 || !_tmp_valid_27) && _tmp_valid_25);
  assign zdata = _tmp_data_26;
  assign zvalid = _tmp_valid_26;
  assign _tmp_ready_26 = zready;
  assign vdata = _tmp_data_27;
  assign vvalid = _tmp_valid_27;
  assign _tmp_ready_27 = vready;
  ...
  always @(posedge CLK) begin
    if(RST) begin
      ...
      if((_tmp_ready_26 || !_tmp_valid_26) && (_tmp_ready_25 && _tmp_ready_24) && (_tmp_valid_25 && _tmp_valid_24)) begin
        _tmp_data_26 <= (_tmp_data_25)? _tmp_data_24 : 1'sd0;
      end 
      if(_tmp_valid_26 && _tmp_ready_26) begin
        _tmp_valid_26 <= 0;
      end 
      if((_tmp_ready_26 || !_tmp_valid_26) && (_tmp_ready_25 && _tmp_ready_24)) begin
        _tmp_valid_26 <= _tmp_valid_25 && _tmp_valid_24;
      end 
