...
(
  ...
  reg _tmp_valid_1;
  wire _tmp_ready_1;
  assign xready = (_tmp_ready_1 || !_tmp_valid_1) && (xvalid && 1'b1);
  assign _tmp_ready_0 = (_tmp_ready_1 || !_tmp_valid_1) && (xvalid && 1'b1);
  ...
  always @(posedge CLK) begin
    if(RST) begin
      ...
      if((_tmp_ready_1 || !_tmp_valid_1) && (xready && _tmp_ready_0) && (xvalid && 1'b1)) begin
        _tmp_data_1 <= xdata + 1;
      end 
      if(_tmp_valid_1 && _tmp_ready_1) begin
        _tmp_valid_1 <= 0;
      end 
      if((_tmp_ready_1 || !_tmp_valid_1) && (xready && _tmp_ready_0)) begin
        _tmp_valid_1 <= xvalid && 1'b1;
      end 
    end
  end
