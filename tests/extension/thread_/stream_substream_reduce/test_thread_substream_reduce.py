...
(
  ...
  reg __macstream_c_fsm_3_cond_14_0_1;
  reg __macstream_c_fsm_3_cond_15_1_1;
  ...
  reg __macstream_v_fsm_4_cond_14_0_1;
  reg __macstream_v_fsm_4_cond_15_1_1;
  ...
  reg __mystream_z_fsm_3_cond_17_0_1;
  reg __mystream_z_fsm_3_cond_18_1_1;
  ...
  localparam _macstream_fsm_16 = 16;
    ...
    if(RST) begin
      ...
      case(_d6__macstream_fsm)
        _macstream_fsm_init: begin
          if(__macstream_fsm_cond_0_2_6) begin
      ...
      case(_macstream_fsm)
        ...
        _macstream_fsm_15: begin
          _macstream_fsm <= _macstream_fsm_16;
        end
        _macstream_fsm_16: begin
          _macstream_busy <= 0;
          _macstream_fsm <= _macstream_fsm_init;
        end
      endcase
  ...
  always @(posedge CLK) begin
    if(RST) begin
      ...
      if(_tmp_132) begin
        __variable_wdata_11 <= ram_a_0_rdata;
      end 
      ...
      if(_tmp_133) begin
        __variable_wdata_12 <= ram_b_0_rdata;
      end 
    ...
    if(RST) begin
      ...
      case(_macstream_a_fsm_1)
        _macstream_a_fsm_1_init: begin
          if(th_comp == 7) begin
            _macstream_a_offset_1 <= _th_comp_offset_6;
            _macstream_a_size_1 <= _th_comp_size_5;
    ...
    if(RST) begin
      ...
      case(_macstream_b_fsm_2)
        _macstream_b_fsm_2_init: begin
          if(th_comp == 8) begin
            _macstream_b_offset_2 <= _th_comp_offset_6;
            _macstream_b_size_2 <= _th_comp_size_5;
  ...
  localparam _macstream_c_fsm_3_15 = 15;
  ...
  always @(posedge CLK) begin
    if(RST) begin
      ...
      __macstream_c_fsm_3_cond_14_0_1 <= 0;
      __macstream_c_fsm_3_cond_15_1_1 <= 0;
    end else begin
      _d1__macstream_c_fsm_3 <= _macstream_c_fsm_3;
      case(_d1__macstream_c_fsm_3)
        _macstream_c_fsm_3_14: begin
          if(__macstream_c_fsm_3_cond_14_0_1) begin
            _macstream_c_wenable_3 <= 0;
          end 
        end
        _macstream_c_fsm_3_15: begin
          if(__macstream_c_fsm_3_cond_15_1_1) begin
            _macstream_c_wenable_3 <= 0;
          end 
        end
      endcase
      case(_macstream_c_fsm_3)
        _macstream_c_fsm_3_init: begin
          if(th_comp == 10) begin
            _macstream_c_offset_3 <= _th_comp_offset_6;
            _macstream_c_size_3 <= _th_comp_size_5;
        ...
        _macstream_c_fsm_3_14: begin
          ...
          __macstream_c_fsm_3_cond_14_0_1 <= 1;
          if(_macstream_c_count_3 == 1) begin
            _macstream_c_fsm_3 <= _macstream_c_fsm_3_init;
          end 
          if(_macstream_c_count_3 > 1) begin
            _macstream_c_fsm_3 <= _macstream_c_fsm_3_15;
          end 
        end
        _macstream_c_fsm_3_15: begin
          ...
          _macstream_c_wenable_3 <= 1;
          _macstream_c_count_3 <= _macstream_c_count_3 - 1;
          __macstream_c_fsm_3_cond_15_1_1 <= 1;
          if(_macstream_c_count_3 == 1) begin
            _macstream_c_fsm_3 <= _macstream_c_fsm_3_init;
          end 
        end
  ...
  localparam _macstream_v_fsm_4_15 = 15;
  ...
  always @(posedge CLK) begin
    if(RST) begin
      ...
      __macstream_v_fsm_4_cond_14_0_1 <= 0;
      __macstream_v_fsm_4_cond_15_1_1 <= 0;
    end else begin
      _d1__macstream_v_fsm_4 <= _macstream_v_fsm_4;
      case(_d1__macstream_v_fsm_4)
        _macstream_v_fsm_4_14: begin
          if(__macstream_v_fsm_4_cond_14_0_1) begin
            _macstream_v_wenable_4 <= 0;
          end 
        end
        _macstream_v_fsm_4_15: begin
          if(__macstream_v_fsm_4_cond_15_1_1) begin
            _macstream_v_wenable_4 <= 0;
          end 
        end
      endcase
      case(_macstream_v_fsm_4)
        _macstream_v_fsm_4_init: begin
          if(th_comp == 11) begin
            _macstream_v_offset_4 <= _th_comp_offset_6;
            _macstream_v_size_4 <= _th_comp_size_5;
        ...
        _macstream_v_fsm_4_14: begin
          ...
          __macstream_v_fsm_4_cond_14_0_1 <= 1;
          if(_macstream_v_count_4 == 1) begin
            _macstream_v_fsm_4 <= _macstream_v_fsm_4_init;
          end 
          if(_macstream_v_count_4 > 1) begin
            _macstream_v_fsm_4 <= _macstream_v_fsm_4_15;
          end 
        end
        _macstream_v_fsm_4_15: begin
          ...
          _macstream_v_wenable_4 <= 1;
          _macstream_v_count_4 <= _macstream_v_count_4 - 1;
          __macstream_v_fsm_4_cond_15_1_1 <= 1;
          if(_macstream_v_count_4 == 1) begin
            _macstream_v_fsm_4 <= _macstream_v_fsm_4_init;
          end 
        end
  ...
  always @(posedge CLK) begin
    if(RST) begin
      ...
      __mystream_z_fsm_3_cond_17_0_1 <= 0;
      __mystream_z_fsm_3_cond_18_1_1 <= 0;
    end else begin
      _d1__mystream_z_fsm_3 <= _mystream_z_fsm_3;
      case(_d1__mystream_z_fsm_3)
        _mystream_z_fsm_3_17: begin
          if(__mystream_z_fsm_3_cond_17_0_1) begin
            _mystream_z_wenable_3 <= 0;
          end 
        end
        _mystream_z_fsm_3_18: begin
          if(__mystream_z_fsm_3_cond_18_1_1) begin
            _mystream_z_wenable_3 <= 0;
          end 
        end
      endcase
      case(_mystream_z_fsm_3)
        _mystream_z_fsm_3_init: begin
          if(th_comp == 66) begin
            ...
            _mystream_z_size_3 <= _th_comp_size_21 >>> 2;
        ...
        _mystream_z_fsm_3_17: begin
          ...
          __mystream_z_fsm_3_cond_17_0_1 <= 1;
        ...
        _mystream_z_fsm_3_18: begin
          ...
          __mystream_z_fsm_3_cond_18_1_1 <= 1;
          if(mystream_v_data && (_mystream_z_count_3 == 1)) begin
            _mystream_z_fsm_3 <= _mystream_z_fsm_3_init;
          end 
        end
