...
import veriloggen
import thread_stream_countervalid
...
(
  ...
  assign mystream_c_data = _plus_data_13;
  reg _set_flag_14;
  reg signed [32-1:0] __parametervariable_wdata_0;
  assign mystream_size_data = __parametervariable_wdata_0;
  reg _set_flag_15;
  reg _tmp_16;
  reg _ram_a_cond_1_1;
  reg _ram_a_cond_2_1;
  ...
  assign _tmp_18 = _mystream_a_source_ram_renable && (_mystream_a_source_ram_sel == 1);
  reg [_tmp_17-1:0] __tmp_18_1;
  reg signed [32-1:0] __variable_wdata_8;
  assign mystream_a_data = __variable_wdata_8;
  ...
  assign _tmp_22 = _mystream_b_source_ram_renable && (_mystream_b_source_ram_sel == 2);
  reg [_tmp_21-1:0] __tmp_22_1;
  reg signed [32-1:0] __variable_wdata_9;
  assign mystream_b_data = __variable_wdata_9;
  ...
  reg signed [32-1:0] _th_comp_cnt_7;
  ...
  reg signed [32-1:0] _th_comp_size_11;
  ...
  always @(posedge CLK) begin
    if(RST) begin
      ...
      if(th_comp == 36) begin
        ram_a_0_addr <= _th_comp_i_8 + _th_comp_offset_5;
      end 
  ...
  always @(posedge CLK) begin
    if(RST) begin
      ...
      if(th_comp == 38) begin
        ram_b_0_addr <= _th_comp_i_8 + _th_comp_offset_5;
      end 
  ...
  always @(posedge CLK) begin
    if(RST) begin
      ...
      _counter_count_3 <= (_counter_count_3 == mystream_size_data - 1)? 0 : _counter_count_3 + 1;
      ...
      _plus_data_12 <= mystream_a_data + mystream_b_data;
      _cond_data_10 <= (_pulse_data_6)? 11'sd1000 : _counter_data_3;
      __delay_data_14 <= _plus_data_12;
      _plus_data_13 <= __delay_data_14 + _cond_data_10;
      _set_flag_14 <= 0;
      if(th_comp == 11) begin
        _set_flag_14 <= 1;
      end 
      if(_set_flag_14) begin
        __parametervariable_wdata_0 <= _th_comp_size_2 >>> 1;
      end 
      _set_flag_15 <= 0;
      if(th_comp == 12) begin
        _set_flag_15 <= 1;
      end 
      if(_set_flag_15) begin
      ...
      __tmp_18_1 <= _tmp_18;
      _mystream_a_source_ram_rvalid <= __tmp_18_1;
      if(_mystream_a_source_ram_rvalid) begin
        __variable_wdata_8 <= _mystream_a_source_ram_rdata;
      end 
      ...
      __tmp_22_1 <= _tmp_22;
      _mystream_b_source_ram_rvalid <= __tmp_22_1;
      if(_mystream_b_source_ram_rvalid) begin
        __variable_wdata_9 <= _mystream_b_source_ram_rdata;
      end 
      ...
      if(_mystream_c_sink_fsm_2 == 8) begin
        _mystream_c_sink_wenable <= 0;
      end 
      if(_mystream_c_sink_fsm_2 == 8) begin
  ...
  always @(posedge CLK) begin
    if(RST) begin
      ...
      case(th_comp)
        ...
        th_comp_35: begin
          if(_th_comp_i_8 < _th_comp_size_4) begin
            th_comp <= th_comp_36;
          end else begin
            th_comp <= th_comp_48;
          end
        ...
        th_comp_39: begin
          _th_comp_b_10 <= _tmp_47;
          th_comp <= th_comp_40;
        end
        th_comp_40: begin
          _th_comp_sum_6 <= _th_comp_a_9 + _th_comp_b_10 + _th_comp_cnt_7;
          th_comp <= th_comp_41;
        end
        th_comp_41: begin
          _th_comp_cnt_7 <= _th_comp_cnt_7 + 1;
          th_comp <= th_comp_42;
        end
        th_comp_42: begin
          if(_th_comp_cnt_7 == 1001) begin
            th_comp <= th_comp_43;
          end else begin
            th_comp <= th_comp_44;
          end
        ...
        th_comp_44: begin
          if(_th_comp_cnt_7 == (_th_comp_size_4 >>> 1) - 1) begin
            th_comp <= th_comp_45;
          end else begin
            th_comp <= th_comp_46;
          end
        ...
        th_comp_52: begin
          _th_comp_size_11 <= _th_comp_size_0;
          _th_comp_offset_stream_12 <= 0;
          _th_comp_offset_seq_13 <= _th_comp_offset_1;
          th_comp <= th_comp_53;
        end
        th_comp_53: begin
        ...
        th_comp_55: begin
          if(_th_comp_i_15 < _th_comp_size_11) begin
            th_comp <= th_comp_56;
          end else begin
            th_comp <= th_comp_63;
          end
...
def test():
    veriloggen.reset()
    test_module = thread_stream_countervalid.mkTest()
