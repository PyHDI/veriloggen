...
(
  ...
  wire [32-1:0] _tmp_213;
  reg [32-1:0] __tmp_213_1;
  ...
  reg _tmp_220;
  wire [32-1:0] _tmp_data_221;
  wire _tmp_valid_221;
  wire _tmp_ready_221;
  assign _tmp_ready_221 = (_tmp_fsm_11 == 4) && ((_tmp_219 > 0) && (myaxi_wready || !myaxi_wvalid));
  ...
  always @(posedge CLK) begin
    if(RST) begin
      ...
      if(_tmp_valid_221 && ((_tmp_fsm_11 == 4) && ((_tmp_219 > 0) && (myaxi_wready || !myaxi_wvalid))) && ((_tmp_219 > 0) && (myaxi_wready || !myaxi_wvalid) && (_tmp_219 > 0))) begin
        myaxi_wdata <= _tmp_data_221;
        myaxi_wvalid <= 1;
        myaxi_wlast <= 0;
        myaxi_wstrb <= { 4{ 1'd1 } };
        _tmp_219 <= _tmp_219 - 1;
      end 
      if(_tmp_valid_221 && ((_tmp_fsm_11 == 4) && ((_tmp_219 > 0) && (myaxi_wready || !myaxi_wvalid))) && ((_tmp_219 > 0) && (myaxi_wready || !myaxi_wvalid) && (_tmp_219 > 0)) && (_tmp_219 == 1)) begin
        myaxi_wlast <= 1;
        _tmp_220 <= 1;
      end 
      _myaxi_cond_15_1 <= 1;
  ...
  wire _tmp_valid_227;
  wire _tmp_ready_227;
  wire [64-1:0] _tmp_odata_227;
  reg [64-1:0] _tmp_data_reg_227;
  assign _tmp_data_227 = _tmp_data_reg_227;
  wire _tmp_ovalid_227;
  reg _tmp_valid_reg_227;
  assign _tmp_valid_227 = _tmp_valid_reg_227;
  wire _tmp_enable_227;
  wire _tmp_update_227;
  assign _tmp_enable_227 = (_tmp_ready_227 || !_tmp_valid_227) && (_tmp_28 && _tmp_40) && (_tmp_26 && _tmp_38);
  ...
  (
    ...
    .valid(_tmp_ovalid_227),
    .a(_tmp_32),
    .b(_tmp_44),
    .c(_tmp_odata_227)
  );

  assign _tmp_28 = 1 && ((_tmp_ready_227 || !_tmp_valid_227) && (_tmp_26 && _tmp_38));
  assign _tmp_40 = 1 && ((_tmp_ready_227 || !_tmp_valid_227) && (_tmp_26 && _tmp_38));
  assign _tmp_data_52 = _tmp_data_227;
  assign _tmp_valid_52 = _tmp_valid_227;
  assign _tmp_ready_227 = _tmp_ready_52;

  always @(posedge CLK) begin
    if(RST) begin
      _tmp_data_reg_227 <= 0;
      _tmp_valid_reg_227 <= 0;
    end else begin
      if(_tmp_ready_227 || !_tmp_valid_227) begin
        _tmp_data_reg_227 <= _tmp_odata_227;
      end 
      if(_tmp_ready_227 || !_tmp_valid_227) begin
        _tmp_valid_reg_227 <= _tmp_ovalid_227;
      end 
    end
  end
  ...
  assign _tmp_data_221 = _tmp_213;
  assign _tmp_valid_221 = _tmp_207;
  assign _tmp_209 = 1 && _tmp_ready_221;
