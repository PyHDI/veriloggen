...
(
  ...
  reg _set_flag_28;
  reg _set_flag_29;
  assign _mystream_start_flag = (_set_flag_29)? 1 : 
                                (_set_flag_24)? 1 : 0;
  reg axim_flag_30;
  reg _th_comp_cond_27_2_1;
  ...
  assign _tmp_37 = (__tmp_36_1)? ram_c_0_rdata : __tmp_37_1;
  reg _tmp_38;
  reg _tmp_39;
  reg _tmp_40;
  reg _tmp_41;
  ...
  assign __variable_ready_45 = (_myaxi_write_fsm == 3) && (_myaxi_write_op_sel == 1) && ((_tmp_43 > 0) && (myaxi_wready || !myaxi_wvalid));
  reg _myaxi_cond_2_1;
  assign _myaxi_write_data_done = (_tmp_44 && myaxi_wvalid && myaxi_wready)? 1 : 0;
  reg axim_flag_46;
  reg [32-1:0] _d1__myaxi_write_fsm;
  reg __myaxi_write_fsm_cond_4_0_1;
  reg axim_flag_47;
  reg _th_comp_cond_32_3_1;
  reg axim_flag_48;
  reg _th_comp_cond_36_4_1;
  ...
  always @(posedge CLK) begin
    if(RST) begin
      ...
      if(axim_flag_0) begin
        ...
        _myaxi_ram_a_0_read_global_addr <= 0;
        _myaxi_ram_a_0_read_size <= _th_comp_double_size_1;
      ...
      if(axim_flag_8) begin
        ...
        _myaxi_ram_b_0_read_size <= _th_comp_double_size_1;
      ...
      if(axim_flag_30) begin
        ...
        _myaxi_ram_c_0_write_size <= _th_comp_double_size_1;
      ...
      if((_myaxi_write_fsm == 2) && ((myaxi_awready || !myaxi_awvalid) && (_tmp_43 == 0))) begin
        myaxi_awaddr <= _myaxi_write_cur_global_addr;
        myaxi_awlen <= _myaxi_write_cur_size - 1;
        myaxi_awvalid <= 1;
        _tmp_43 <= _myaxi_write_cur_size;
      end 
      if((_myaxi_write_fsm == 2) && ((myaxi_awready || !myaxi_awvalid) && (_tmp_43 == 0)) && (_myaxi_write_cur_size == 0)) begin
        myaxi_awvalid <= 0;
      end 
      _myaxi_cond_1_1 <= 1;
      ...
      if(__variable_valid_45 && ((_myaxi_write_fsm == 3) && (_myaxi_write_op_sel == 1) && ((_tmp_43 > 0) && (myaxi_wready || !myaxi_wvalid))) && ((_tmp_43 > 0) && (myaxi_wready || !myaxi_wvalid) && (_tmp_43 > 0))) begin
        myaxi_wdata <= __variable_data_45;
        myaxi_wvalid <= 1;
        myaxi_wlast <= 0;
        myaxi_wstrb <= { 4{ 1'd1 } };
        _tmp_43 <= _tmp_43 - 1;
      end 
      if(__variable_valid_45 && ((_myaxi_write_fsm == 3) && (_myaxi_write_op_sel == 1) && ((_tmp_43 > 0) && (myaxi_wready || !myaxi_wvalid))) && ((_tmp_43 > 0) && (myaxi_wready || !myaxi_wvalid) && (_tmp_43 > 0)) && (_tmp_43 == 1)) begin
        myaxi_wlast <= 1;
        _tmp_44 <= 1;
      end 
      _myaxi_cond_2_1 <= 1;
  ...
  always @(posedge CLK) begin
    if(RST) begin
      ...
      _ram_a_cond_3_1 <= th_comp == 44;
      _ram_a_cond_4_1 <= th_comp == 44;
    end
  end
  ...
  always @(posedge CLK) begin
    if(RST) begin
      ...
      _ram_b_cond_3_1 <= th_comp == 46;
      _ram_b_cond_4_1 <= th_comp == 46;
    end
  end
  ...
  always @(posedge CLK) begin
    if(RST) begin
      ...
      if(_myaxi_write_start && (_myaxi_write_op_sel == 1) && (_tmp_42 == 0) && !_tmp_40 && !_tmp_41) begin
        ram_c_0_addr <= _myaxi_write_local_addr;
        _tmp_42 <= _myaxi_write_size - 1;
        _tmp_38 <= 1;
      ...
      _ram_c_cond_1_1 <= th_comp == 49;
      if(th_comp == 59) begin
        ram_c_0_addr <= _th_comp_i_20 + _th_comp_offset_stream_17;
      end 
      _ram_c_cond_2_1 <= th_comp == 59;
      _ram_c_cond_3_1 <= th_comp == 59;
      if(th_comp == 61) begin
        ram_c_0_addr <= _th_comp_i_20 + _th_comp_offset_seq_18;
      end 
      _ram_c_cond_4_1 <= th_comp == 61;
      _ram_c_cond_5_1 <= th_comp == 61;
    end
  end
  ...
  always @(posedge CLK) begin
    if(RST) begin
      ...
      if(_mystream_c_sink_fsm_2 == 7) begin
        _mystream_c_sink_wenable <= 0;
      end 
      if(_mystream_c_sink_fsm_2 == 7) begin
  ...
  always @(posedge CLK) begin
    if(RST) begin
      ...
      _th_comp_bias_8 <= 0;
      axim_flag_30 <= 0;
      _th_comp_cond_27_2_1 <= 0;
      axim_flag_47 <= 0;
      _th_comp_cond_32_3_1 <= 0;
      axim_flag_48 <= 0;
      _th_comp_cond_36_4_1 <= 0;
      _th_comp_size_9 <= 0;
      ...
      case(_d1_th_comp)
        ...
        th_comp_27: begin
          if(_th_comp_cond_27_2_1) begin
            axim_flag_30 <= 0;
          end 
        end
        th_comp_32: begin
          if(_th_comp_cond_32_3_1) begin
            axim_flag_47 <= 0;
          end 
        end
        th_comp_36: begin
          if(_th_comp_cond_36_4_1) begin
            axim_flag_48 <= 0;
          end 
        end
        th_comp_51: begin
          if(_th_comp_cond_51_5_1) begin
            axim_flag_53 <= 0;
          end 
        end
      endcase
