...
import veriloggen
import thread_stream_pattern_zero
...
(
  ...
  assign mystream_sum_data = _plus_data_2;
  ...
  always @(posedge CLK) begin
    if(RST) begin
      ...
      if(th_comp == 34) begin
        ram_a_0_addr <= _th_comp_offset_2 + 10;
      end 
  ...
  always @(posedge CLK) begin
    if(RST) begin
      ...
      if(th_comp == 36) begin
        ram_b_0_addr <= _th_comp_offset_2 + 10;
      end 
  ...
  always @(posedge CLK) begin
    if(RST) begin
      ...
      if(_set_flag_14) begin
        ...
        _mystream_a_source_offset <= _th_comp_offset_1 + 10;
      end 
      if(_set_flag_14) begin
        _source_mystream_a_pat_size_0 <= 16;
        _source_mystream_a_pat_stride_0 <= 0;
      end 
      if(_set_flag_14) begin
      ...
      if(_set_flag_18) begin
        ...
        _mystream_b_source_offset <= _th_comp_offset_1 + 10;
      end 
      if(_set_flag_18) begin
        _source_mystream_b_pat_size_0 <= 16;
        _source_mystream_b_pat_stride_0 <= 0;
      end 
      if(_set_flag_18) begin
      ...
      if(_set_flag_22) begin
        ...
        _mystream_sum_sink_offset <= _th_comp_offset_1;
        _mystream_sum_sink_size <= 16;
      ...
      if(_mystream_sum_sink_fsm_2 == 6) begin
        _mystream_sum_sink_wenable <= 0;
      end 
      if(_mystream_sum_sink_fsm_2 == 6) begin
    ...
    if(RST) begin
      ...
      case(_mystream_sum_sink_fsm_2)
        ...
        _mystream_sum_sink_fsm_2_6: begin
          if(_mystream_sum_sink_count == 1) begin
            _mystream_sum_sink_fsm_2 <= _mystream_sum_sink_fsm_2_init;
          end 
        end
      endcase
...
def test():
    veriloggen.reset()
    test_module = thread_stream_pattern_zero.mkTest()
