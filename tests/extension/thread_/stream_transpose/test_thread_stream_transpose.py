...
(
  ...
  reg _mystream_b_sink_mode;
  reg [32-1:0] _mystream_b_sink_offset;
  reg [33-1:0] _mystream_b_sink_size;
  reg [32-1:0] _mystream_b_sink_stride;
  reg [33-1:0] _mystream_b_sink_count;
  reg [8-1:0] _mystream_b_sink_ram_sel;
  reg [32-1:0] _mystream_b_sink_waddr;
  reg _mystream_b_sink_wenable;
  reg [32-1:0] _mystream_b_sink_wdata;
  reg [32-1:0] th_comp;
  ...
  reg [32-1:0] _sink_mystream_b_pat_offset_0;
  reg [32-1:0] _sink_mystream_b_pat_offset_1;
  reg [32-1:0] _sink_mystream_b_pat_offset_2;
  reg [32-1:0] _sink_mystream_b_pat_offset_3;
  reg [33-1:0] _sink_mystream_b_pat_size_0;
  reg [33-1:0] _sink_mystream_b_pat_size_1;
  reg [33-1:0] _sink_mystream_b_pat_size_2;
  reg [33-1:0] _sink_mystream_b_pat_size_3;
  reg [32-1:0] _sink_mystream_b_pat_stride_0;
  reg [32-1:0] _sink_mystream_b_pat_stride_1;
  reg [32-1:0] _sink_mystream_b_pat_stride_2;
  reg [32-1:0] _sink_mystream_b_pat_stride_3;
  reg [33-1:0] _sink_mystream_b_pat_count_0;
  reg [33-1:0] _sink_mystream_b_pat_count_1;
  reg [33-1:0] _sink_mystream_b_pat_count_2;
  reg [33-1:0] _sink_mystream_b_pat_count_3;
  reg _set_flag_12;
  reg _ram_b_cond_0_1;
  reg [32-1:0] _mystream_b_sink_pat_fsm_1;
  localparam _mystream_b_sink_pat_fsm_1_init = 0;
  wire [32-1:0] _mystream_b_sink_pat_all_offset;
  assign _mystream_b_sink_pat_all_offset = _mystream_b_sink_offset + _sink_mystream_b_pat_offset_0 + _sink_mystream_b_pat_offset_1 + _sink_mystream_b_pat_offset_2 + _sink_mystream_b_pat_offset_3;
  reg _set_flag_13;
  assign _mystream_start_flag = (_set_flag_13)? 1 : 0;
  wire _mystream_done;
  ...
  wire signed [32-1:0] _tmp_21;
  reg signed [32-1:0] __tmp_21_1;
  assign _tmp_21 = (__tmp_20_1)? ram_b_0_rdata : __tmp_21_1;
  reg _tmp_22;
  reg _tmp_23;
  reg _tmp_24;
  reg _tmp_25;
  ...
  assign __variable_ready_29 = (_myaxi_write_fsm == 3) && (_myaxi_write_op_sel == 1) && ((_tmp_27 > 0) && (myaxi_wready || !myaxi_wvalid));
  reg _myaxi_cond_2_1;
  assign _myaxi_write_data_done = (_tmp_28 && myaxi_wvalid && myaxi_wready)? 1 : 0;
  reg axim_flag_30;
  ...
  always @(posedge CLK) begin
    if(RST) begin
      ...
      _myaxi_ram_b_0_write_start <= 0;
      if(axim_flag_14) begin
        _myaxi_ram_b_0_write_start <= 1;
        _myaxi_ram_b_0_write_op_sel <= 1;
        _myaxi_ram_b_0_write_local_addr <= _th_comp_offset_0;
        _myaxi_ram_b_0_write_global_addr <= 4096;
        _myaxi_ram_b_0_write_size <= 64;
      ...
      if((_myaxi_write_fsm == 2) && ((myaxi_awready || !myaxi_awvalid) && (_tmp_27 == 0))) begin
        myaxi_awaddr <= _myaxi_write_cur_global_addr;
        myaxi_awlen <= _myaxi_write_cur_size - 1;
        myaxi_awvalid <= 1;
        _tmp_27 <= _myaxi_write_cur_size;
      end 
      if((_myaxi_write_fsm == 2) && ((myaxi_awready || !myaxi_awvalid) && (_tmp_27 == 0)) && (_myaxi_write_cur_size == 0)) begin
        myaxi_awvalid <= 0;
      end 
      _myaxi_cond_1_1 <= 1;
      ...
      if(__variable_valid_29 && ((_myaxi_write_fsm == 3) && (_myaxi_write_op_sel == 1) && ((_tmp_27 > 0) && (myaxi_wready || !myaxi_wvalid))) && ((_tmp_27 > 0) && (myaxi_wready || !myaxi_wvalid) && (_tmp_27 > 0))) begin
      ...
      if(__variable_valid_29 && ((_myaxi_write_fsm == 3) && (_myaxi_write_op_sel == 1) && ((_tmp_27 > 0) && (myaxi_wready || !myaxi_wvalid))) && ((_tmp_27 > 0) && (myaxi_wready || !myaxi_wvalid) && (_tmp_27 > 0)) && (_tmp_27 == 1)) begin
        myaxi_wlast <= 1;
        _tmp_28 <= 1;
      end 
      _myaxi_cond_2_1 <= 1;
      ...
      if(axim_flag_34) begin
        ...
        _myaxi_ram_b_0_write_op_sel <= 1;
        _myaxi_ram_b_0_write_local_addr <= _th_comp_offset_0;
        _myaxi_ram_b_0_write_global_addr <= 8192;
        _myaxi_ram_b_0_write_size <= 64;
        _myaxi_ram_b_0_write_local_stride <= 1;
      end 
    end
  ...
  always @(posedge CLK) begin
    if(RST) begin
      ...
      _ram_a_cond_3_1 <= th_comp == 31;
      _ram_a_cond_4_1 <= th_comp == 31;
    end
  end
  ...
  always @(posedge CLK) begin
    if(RST) begin
      ...
      if(_mystream_b_sink_wenable && (_mystream_b_sink_ram_sel == 2)) begin
        ram_b_0_addr <= _mystream_b_sink_waddr;
        ram_b_0_wdata <= _mystream_b_sink_wdata;
        ram_b_0_wenable <= 1;
      end 
      _ram_b_cond_0_1 <= _mystream_b_sink_wenable && (_mystream_b_sink_ram_sel == 2);
      __tmp_20_1 <= _tmp_20;
      __tmp_21_1 <= _tmp_21;
      ...
      if((_tmp_17 || !_tmp_15) && (_tmp_18 || !_tmp_16) && _tmp_22) begin
        _tmp_15 <= 1;
        _tmp_16 <= 1;
        _tmp_25 <= _tmp_24;
        _tmp_24 <= 0;
      ...
      if(_myaxi_write_start && (_myaxi_write_op_sel == 1) && (_tmp_26 == 0) && !_tmp_24 && !_tmp_25) begin
        ram_b_0_addr <= _myaxi_write_local_addr;
        _tmp_26 <= _myaxi_write_size - 1;
        _tmp_22 <= 1;
        _tmp_24 <= _myaxi_write_size == 1;
      end 
      if((_tmp_17 || !_tmp_15) && (_tmp_18 || !_tmp_16) && (_tmp_26 > 0)) begin
        ram_b_0_addr <= ram_b_0_addr + _myaxi_write_local_stride;
        _tmp_26 <= _tmp_26 - 1;
        _tmp_22 <= 1;
        _tmp_24 <= 0;
      end 
      if((_tmp_17 || !_tmp_15) && (_tmp_18 || !_tmp_16) && (_tmp_26 == 1)) begin
        _tmp_24 <= 1;
      end 
      if(th_comp == 33) begin
      ...
      _ram_b_cond_1_1 <= th_comp == 33;
      if(th_comp == 52) begin
        ram_b_0_addr <= _th_comp_i_13 + _th_comp_offset_stream_10;
      end 
      _ram_b_cond_2_1 <= th_comp == 52;
      _ram_b_cond_3_1 <= th_comp == 52;
      if(th_comp == 54) begin
        ram_b_0_addr <= _th_comp_i_13 + _th_comp_offset_seq_11;
      end 
      _ram_b_cond_4_1 <= th_comp == 54;
      _ram_b_cond_5_1 <= th_comp == 54;
    end
  end

  assign __variable_data_29 = _tmp_21;
  assign __variable_valid_29 = _tmp_15;
  assign _tmp_17 = 1 && __variable_ready_29;
  ...
  always @(posedge CLK) begin
    if(RST) begin
      ...
      _set_flag_12 <= 0;
      _mystream_b_sink_mode <= 0;
      _mystream_b_sink_offset <= 0;
      _sink_mystream_b_pat_size_0 <= 0;
      _sink_mystream_b_pat_stride_0 <= 0;
      _sink_mystream_b_pat_size_1 <= 0;
      _sink_mystream_b_pat_stride_1 <= 0;
      _sink_mystream_b_pat_size_2 <= 0;
      _sink_mystream_b_pat_stride_2 <= 0;
      _sink_mystream_b_pat_size_3 <= 0;
      _sink_mystream_b_pat_stride_3 <= 0;
      _mystream_b_sink_ram_sel <= 0;
      _mystream_b_sink_wenable <= 0;
      _mystream_b_sink_waddr <= 0;
      _sink_mystream_b_pat_offset_0 <= 0;
      _sink_mystream_b_pat_offset_1 <= 0;
      _sink_mystream_b_pat_offset_2 <= 0;
      _sink_mystream_b_pat_offset_3 <= 0;
      _sink_mystream_b_pat_count_0 <= 0;
      _sink_mystream_b_pat_count_1 <= 0;
      _sink_mystream_b_pat_count_2 <= 0;
      _sink_mystream_b_pat_count_3 <= 0;
      _mystream_b_sink_wdata <= 0;
      _set_flag_13 <= 0;
    end else begin
      _set_flag_8 <= 0;
      if(th_comp == 7) begin
      ...
      if(_set_flag_8) begin
        _source_mystream_a_pat_size_0 <= 8;
        _source_mystream_a_pat_stride_0 <= 8;
      end 
      if(_set_flag_8) begin
        _source_mystream_a_pat_size_1 <= 2;
        _source_mystream_a_pat_stride_1 <= 4;
      end 
      if(_set_flag_8) begin
        _source_mystream_a_pat_size_2 <= 4;
      ...
      if(_set_flag_12) begin
        _mystream_b_sink_mode <= 1;
        _mystream_b_sink_offset <= _th_comp_offset_1;
      end 
      if(_set_flag_12) begin
        _sink_mystream_b_pat_size_0 <= 4;
        _sink_mystream_b_pat_stride_0 <= 1;
      end 
      if(_set_flag_12) begin
        _sink_mystream_b_pat_size_1 <= 2;
        _sink_mystream_b_pat_stride_1 <= 4;
      end 
      if(_set_flag_12) begin
        _sink_mystream_b_pat_size_2 <= 8;
        _sink_mystream_b_pat_stride_2 <= 8;
      end 
      if(_set_flag_12) begin
        _sink_mystream_b_pat_size_3 <= 1;
        _sink_mystream_b_pat_stride_3 <= 0;
      end 
      if(_set_flag_12) begin
        _mystream_b_sink_ram_sel <= 2;
      end 
      if(_mystream_b_sink_pat_fsm_1 == 0) begin
        _mystream_b_sink_wenable <= 0;
      end 
      if(_mystream_b_sink_pat_fsm_1 == 1) begin
        _mystream_b_sink_waddr <= _mystream_b_sink_offset - _mystream_b_sink_stride;
      end 
      if(_mystream_b_sink_pat_fsm_1 == 1) begin
        _sink_mystream_b_pat_offset_0 <= 0;
      end 
      ...
      if(_mystream_b_sink_pat_fsm_1 == 1) begin
        _sink_mystream_b_pat_count_0 <= _sink_mystream_b_pat_size_0 - 1;
      end 
      if(_mystream_b_sink_pat_fsm_1 == 1) begin
        _sink_mystream_b_pat_count_1 <= _sink_mystream_b_pat_size_1 - 1;
      end 
      if(_mystream_b_sink_pat_fsm_1 == 1) begin
        _sink_mystream_b_pat_count_2 <= _sink_mystream_b_pat_size_2 - 1;
      end 
      if(_mystream_b_sink_pat_fsm_1 == 1) begin
        _sink_mystream_b_pat_count_3 <= _sink_mystream_b_pat_size_3 - 1;
      end 
      if(_mystream_b_sink_pat_fsm_1 == 5) begin
        _mystream_b_sink_wenable <= 0;
      end 
      if(_mystream_b_sink_pat_fsm_1 == 5) begin
        _mystream_b_sink_waddr <= _mystream_b_sink_pat_all_offset;
        _mystream_b_sink_wdata <= mystream_b_data;
        _mystream_b_sink_wenable <= 1;
      end 
      if(_mystream_b_sink_pat_fsm_1 == 5) begin
        _sink_mystream_b_pat_offset_0 <= _sink_mystream_b_pat_offset_0 + _sink_mystream_b_pat_stride_0;
        _sink_mystream_b_pat_count_0 <= _sink_mystream_b_pat_count_0 - 1;
      end 
      if((_mystream_b_sink_pat_fsm_1 == 5) && (_sink_mystream_b_pat_count_0 == 0)) begin
        _sink_mystream_b_pat_offset_0 <= 0;
        _sink_mystream_b_pat_count_0 <= _sink_mystream_b_pat_size_0 - 1;
      end 
      if((_mystream_b_sink_pat_fsm_1 == 5) && (_sink_mystream_b_pat_count_0 == 0)) begin
        _sink_mystream_b_pat_offset_1 <= _sink_mystream_b_pat_offset_1 + _sink_mystream_b_pat_stride_1;
        _sink_mystream_b_pat_count_1 <= _sink_mystream_b_pat_count_1 - 1;
      end 
      if((_mystream_b_sink_pat_fsm_1 == 5) && (_sink_mystream_b_pat_count_0 == 0) && (_sink_mystream_b_pat_count_1 == 0)) begin
        _sink_mystream_b_pat_offset_1 <= 0;
        _sink_mystream_b_pat_count_1 <= _sink_mystream_b_pat_size_1 - 1;
      end 
      if((_mystream_b_sink_pat_fsm_1 == 5) && ((_sink_mystream_b_pat_count_0 == 0) && (_sink_mystream_b_pat_count_1 == 0))) begin
        _sink_mystream_b_pat_offset_2 <= _sink_mystream_b_pat_offset_2 + _sink_mystream_b_pat_stride_2;
        _sink_mystream_b_pat_count_2 <= _sink_mystream_b_pat_count_2 - 1;
      end 
      if((_mystream_b_sink_pat_fsm_1 == 5) && ((_sink_mystream_b_pat_count_0 == 0) && (_sink_mystream_b_pat_count_1 == 0)) && (_sink_mystream_b_pat_count_2 == 0)) begin
        _sink_mystream_b_pat_offset_2 <= 0;
        _sink_mystream_b_pat_count_2 <= _sink_mystream_b_pat_size_2 - 1;
      end 
      if((_mystream_b_sink_pat_fsm_1 == 5) && ((_sink_mystream_b_pat_count_0 == 0) && (_sink_mystream_b_pat_count_1 == 0) && (_sink_mystream_b_pat_count_2 == 0))) begin
        _sink_mystream_b_pat_offset_3 <= _sink_mystream_b_pat_offset_3 + _sink_mystream_b_pat_stride_3;
        _sink_mystream_b_pat_count_3 <= _sink_mystream_b_pat_count_3 - 1;
      end 
      if((_mystream_b_sink_pat_fsm_1 == 5) && ((_sink_mystream_b_pat_count_0 == 0) && (_sink_mystream_b_pat_count_1 == 0) && (_sink_mystream_b_pat_count_2 == 0)) && (_sink_mystream_b_pat_count_3 == 0)) begin
        _sink_mystream_b_pat_offset_3 <= 0;
        _sink_mystream_b_pat_count_3 <= _sink_mystream_b_pat_size_3 - 1;
      end 
      _set_flag_13 <= 0;
  ...
  localparam _mystream_b_sink_pat_fsm_1_1 = 1;
  localparam _mystream_b_sink_pat_fsm_1_2 = 2;
  localparam _mystream_b_sink_pat_fsm_1_3 = 3;
  localparam _mystream_b_sink_pat_fsm_1_4 = 4;
  localparam _mystream_b_sink_pat_fsm_1_5 = 5;

  always @(posedge CLK) begin
    if(RST) begin
      _mystream_b_sink_pat_fsm_1 <= _mystream_b_sink_pat_fsm_1_init;
    end else begin
      case(_mystream_b_sink_pat_fsm_1)
        _mystream_b_sink_pat_fsm_1_init: begin
          if(_mystream_start && (_mystream_b_sink_mode == 1) && (_sink_mystream_b_pat_size_0 > 0) && (_sink_mystream_b_pat_size_1 > 0) && (_sink_mystream_b_pat_size_2 > 0) && (_sink_mystream_b_pat_size_3 > 0)) begin
            _mystream_b_sink_pat_fsm_1 <= _mystream_b_sink_pat_fsm_1_1;
          end 
        end
        _mystream_b_sink_pat_fsm_1_1: begin
          _mystream_b_sink_pat_fsm_1 <= _mystream_b_sink_pat_fsm_1_2;
        end
        _mystream_b_sink_pat_fsm_1_2: begin
          _mystream_b_sink_pat_fsm_1 <= _mystream_b_sink_pat_fsm_1_3;
        end
        _mystream_b_sink_pat_fsm_1_3: begin
          _mystream_b_sink_pat_fsm_1 <= _mystream_b_sink_pat_fsm_1_4;
        end
        _mystream_b_sink_pat_fsm_1_4: begin
          _mystream_b_sink_pat_fsm_1 <= _mystream_b_sink_pat_fsm_1_5;
        end
        _mystream_b_sink_pat_fsm_1_5: begin
          if((_sink_mystream_b_pat_count_0 == 0) && (_sink_mystream_b_pat_count_1 == 0) && (_sink_mystream_b_pat_count_2 == 0) && (_sink_mystream_b_pat_count_3 == 0)) begin
            _mystream_b_sink_pat_fsm_1 <= _mystream_b_sink_pat_fsm_1_init;
          end 
        end
      endcase
