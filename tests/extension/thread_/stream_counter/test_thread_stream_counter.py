...
(
  ...
  wire [32-1:0] mystream_c_data;
  assign mystream_c_data = _plus_data_7;
  reg _set_flag_14;
  reg _tmp_15;
  reg _ram_a_cond_1_1;
  reg _ram_a_cond_2_1;
  ...
  assign mystream_a_data = __variable_wdata_4;
  ...
  assign mystream_b_data = __variable_wdata_5;
  ...
  always @(posedge CLK) begin
    if(RST) begin
      ...
      _ram_a_cond_3_1 <= th_comp == 35;
      _ram_a_cond_4_1 <= th_comp == 35;
    end
  end
  ...
  always @(posedge CLK) begin
    if(RST) begin
      ...
      _ram_b_cond_3_1 <= th_comp == 37;
      _ram_b_cond_4_1 <= th_comp == 37;
    end
  end
  ...
  always @(posedge CLK) begin
    if(RST) begin
      ...
      _ram_c_cond_1_1 <= th_comp == 41;
      if(th_comp == 51) begin
        ram_c_0_addr <= _th_comp_i_15 + _th_comp_offset_stream_12;
      end 
      _ram_c_cond_2_1 <= th_comp == 51;
      _ram_c_cond_3_1 <= th_comp == 51;
      if(th_comp == 53) begin
        ram_c_0_addr <= _th_comp_i_15 + _th_comp_offset_seq_13;
      end 
      _ram_c_cond_4_1 <= th_comp == 53;
      _ram_c_cond_5_1 <= th_comp == 53;
    end
  end
  ...
  always @(posedge CLK) begin
    if(RST) begin
      ...
      if(_mystream_reduce_reset) begin
        _counter_data_2 <= -2'sd1 + 1;
      end 
      _plus_data_6 <= mystream_a_data + mystream_b_data;
      _plus_data_7 <= _plus_data_6 + _counter_data_2;
      _set_flag_14 <= 0;
      if(th_comp == 11) begin
        _set_flag_14 <= 1;
      end 
      ...
      if(_mystream_a_source_ram_rvalid) begin
        __variable_wdata_4 <= _mystream_a_source_ram_rdata;
      end 
      ...
      if(_mystream_b_source_ram_rvalid) begin
        __variable_wdata_5 <= _mystream_b_source_ram_rdata;
      end 
...
def test():
    veriloggen.reset()
    test_module = thread_stream_counter.mkTest()
