...
(
  ...
  always @(posedge CLK) begin
    if(RST) begin
      ...
      if((th_blink == 24) && (_th_blink_bank_4 == 0)) begin
        myram_0_0_addr <= _th_blink_i_5;
        myram_0_0_wdata <= _th_blink_wdata_6;
        myram_0_0_wenable <= 1;
      end 
      _myram_0_cond_1_1 <= (th_blink == 24) && (_th_blink_bank_4 == 0);
      ...
      _myram_0_cond_5_1 <= th_blink == 63;
      _myram_0_cond_6_1 <= th_blink == 63;
    end
  end
  ...
  always @(posedge CLK) begin
    if(RST) begin
      ...
      if((th_blink == 24) && (_th_blink_bank_4 == 1)) begin
        myram_1_0_addr <= _th_blink_i_5;
        myram_1_0_wdata <= _th_blink_wdata_6;
        myram_1_0_wenable <= 1;
      end 
      _myram_1_cond_1_1 <= (th_blink == 24) && (_th_blink_bank_4 == 1);
      ...
      _myram_1_cond_5_1 <= th_blink == 63;
      _myram_1_cond_6_1 <= th_blink == 63;
    end
  end
  ...
  always @(posedge CLK) begin
    if(RST) begin
      ...
      if((th_blink == 24) && (_th_blink_bank_4 == 2)) begin
        myram_2_0_addr <= _th_blink_i_5;
        myram_2_0_wdata <= _th_blink_wdata_6;
        myram_2_0_wenable <= 1;
      end 
      _myram_2_cond_1_1 <= (th_blink == 24) && (_th_blink_bank_4 == 2);
      ...
      _myram_2_cond_5_1 <= th_blink == 63;
      _myram_2_cond_6_1 <= th_blink == 63;
    end
  end
  ...
  always @(posedge CLK) begin
    if(RST) begin
      ...
      if((th_blink == 24) && (_th_blink_bank_4 == 3)) begin
        myram_3_0_addr <= _th_blink_i_5;
        myram_3_0_wdata <= _th_blink_wdata_6;
        myram_3_0_wenable <= 1;
      end 
      _myram_3_cond_1_1 <= (th_blink == 24) && (_th_blink_bank_4 == 3);
      ...
      _myram_3_cond_5_1 <= th_blink == 63;
      _myram_3_cond_6_1 <= th_blink == 63;
    end
  end
  ...
  always @(posedge CLK) begin
    if(RST) begin
      ...
      axim_flag_55 <= 0;
      _th_blink_cond_36_2_1 <= 0;
      _tmp_76 <= 0;
      _th_blink_rdata_9 <= 0;
      axim_flag_77 <= 0;
      _th_blink_cond_54_3_1 <= 0;
      _tmp_82 <= 0;
    end else begin
      ...
      case(_d1_th_blink)
        ...
        th_blink_36: begin
          if(_th_blink_cond_36_2_1) begin
            axim_flag_55 <= 0;
          end 
        end
        th_blink_54: begin
          if(_th_blink_cond_54_3_1) begin
            axim_flag_77 <= 0;
          end 
        end
      endcase
      case(th_blink)
        ...
        th_blink_45: begin
          if(_tmp_72 && (_th_blink_bank_4 == 0)) begin
            _tmp_76 <= myram_0_0_rdata;
          end 
          if(_tmp_73 && (_th_blink_bank_4 == 1)) begin
            _tmp_76 <= myram_1_0_rdata;
          end 
          if(_tmp_74 && (_th_blink_bank_4 == 2)) begin
            _tmp_76 <= myram_2_0_rdata;
          end 
          if(_tmp_75 && (_th_blink_bank_4 == 3)) begin
        ...
        th_blink_63: begin
          if(_tmp_78 && (_th_blink_bank_4 == 0)) begin
            _tmp_82 <= myram_0_0_rdata;
          end 
          if(_tmp_79 && (_th_blink_bank_4 == 1)) begin
            _tmp_82 <= myram_1_0_rdata;
          end 
          if(_tmp_80 && (_th_blink_bank_4 == 2)) begin
            _tmp_82 <= myram_2_0_rdata;
          end 
          if(_tmp_81 && (_th_blink_bank_4 == 3)) begin
