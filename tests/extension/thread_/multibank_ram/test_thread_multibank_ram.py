...
(
  ...
  always @(posedge CLK) begin
    if(RST) begin
      ...
      if((th_blink == 6) && (_th_blink_b_2 == 0)) begin
        myram_0_0_addr <= _th_blink_i_1;
        myram_0_0_wdata <= _th_blink_wdata_3;
        myram_0_0_wenable <= 1;
      end 
      _myram_0_cond_0_1 <= (th_blink == 6) && (_th_blink_b_2 == 0);
      if(th_blink == 15) begin
        myram_0_0_addr <= _th_blink_i_1;
      end 
      _myram_0_cond_1_1 <= th_blink == 15;
      _myram_0_cond_2_1 <= th_blink == 15;
    end
  end
  ...
  always @(posedge CLK) begin
    if(RST) begin
      ...
      if((th_blink == 6) && (_th_blink_b_2 == 1)) begin
        myram_1_0_addr <= _th_blink_i_1;
        myram_1_0_wdata <= _th_blink_wdata_3;
        myram_1_0_wenable <= 1;
      end 
      _myram_1_cond_0_1 <= (th_blink == 6) && (_th_blink_b_2 == 1);
      if(th_blink == 15) begin
        myram_1_0_addr <= _th_blink_i_1;
      end 
      _myram_1_cond_1_1 <= th_blink == 15;
      _myram_1_cond_2_1 <= th_blink == 15;
    end
  end
  ...
  always @(posedge CLK) begin
    if(RST) begin
      ...
      if((th_blink == 6) && (_th_blink_b_2 == 2)) begin
        myram_2_0_addr <= _th_blink_i_1;
        myram_2_0_wdata <= _th_blink_wdata_3;
        myram_2_0_wenable <= 1;
      end 
      _myram_2_cond_0_1 <= (th_blink == 6) && (_th_blink_b_2 == 2);
      if(th_blink == 15) begin
        myram_2_0_addr <= _th_blink_i_1;
      end 
      _myram_2_cond_1_1 <= th_blink == 15;
      _myram_2_cond_2_1 <= th_blink == 15;
    end
  end
  ...
  always @(posedge CLK) begin
    if(RST) begin
      ...
      if((th_blink == 6) && (_th_blink_b_2 == 3)) begin
        myram_3_0_addr <= _th_blink_i_1;
        myram_3_0_wdata <= _th_blink_wdata_3;
        myram_3_0_wenable <= 1;
      end 
      _myram_3_cond_0_1 <= (th_blink == 6) && (_th_blink_b_2 == 3);
      if(th_blink == 15) begin
        myram_3_0_addr <= _th_blink_i_1;
      end 
      _myram_3_cond_1_1 <= th_blink == 15;
      _myram_3_cond_2_1 <= th_blink == 15;
    end
  end
  ...
  always @(posedge CLK) begin
    if(RST) begin
      ...
      case(th_blink)
        ...
        th_blink_5: begin
          _th_blink_wdata_3 <= _th_blink_i_1 + _th_blink_b_2;
          th_blink <= th_blink_6;
        end
        th_blink_6: begin
          th_blink <= th_blink_7;
        ...
        th_blink_7: begin
          $display("bank:%d wdata = %d", _th_blink_b_2, _th_blink_wdata_3);
          th_blink <= th_blink_8;
        end
        th_blink_8: begin
          _th_blink_b_2 <= _th_blink_b_2 + 1;
          th_blink <= th_blink_4;
        end
        th_blink_9: begin
        ...
        th_blink_15: begin
          if(_tmp_0 && (_th_blink_b_2 == 0)) begin
            _tmp_4 <= myram_0_0_rdata;
          end 
          if(_tmp_1 && (_th_blink_b_2 == 1)) begin
            _tmp_4 <= myram_1_0_rdata;
          end 
          if(_tmp_2 && (_th_blink_b_2 == 2)) begin
            _tmp_4 <= myram_2_0_rdata;
          end 
          if(_tmp_3 && (_th_blink_b_2 == 3)) begin
        ...
        th_blink_18: begin
          $display("bank:%d rdata = %d", _th_blink_b_2, _th_blink_rdata_5);
