...
(
  ...
  reg signed [32-1:0] _th_comp_st_10;
  reg _tmp_50;
  reg _ram_c_cond_4_1;
  reg _ram_c_cond_5_1;
  reg _ram_c_cond_5_2;
  reg signed [32-1:0] _tmp_51;
  reg signed [32-1:0] _th_comp_sq_11;
  ...
  always @(posedge CLK) begin
    if(RST) begin
      ...
      if(th_comp == 47) begin
        ram_c_0_addr <= _th_comp_offset_stream_7;
      end 
      _ram_c_cond_2_1 <= th_comp == 47;
      _ram_c_cond_3_1 <= th_comp == 47;
      if(th_comp == 49) begin
        ram_c_0_addr <= _th_comp_offset_seq_8;
      end 
      _ram_c_cond_4_1 <= th_comp == 49;
      _ram_c_cond_5_1 <= th_comp == 49;
    end
  end
  ...
  always @(posedge CLK) begin
    if(RST) begin
      ...
      if(_set_flag_14) begin
        _source_mystream_a_pat_size_0 <= 4;
        _source_mystream_a_pat_stride_0 <= 8;
      end 
      if(_set_flag_14) begin
        _source_mystream_a_pat_size_1 <= 8;
        _source_mystream_a_pat_stride_1 <= 1;
      end 
      if(_set_flag_14) begin
        _source_mystream_a_pat_size_2 <= 16;
        _source_mystream_a_pat_stride_2 <= 32;
      end 
      if(_set_flag_14) begin
      ...
      if(_set_flag_18) begin
        _source_mystream_b_pat_size_0 <= 4;
        _source_mystream_b_pat_stride_0 <= 8;
      end 
      if(_set_flag_18) begin
        _source_mystream_b_pat_size_1 <= 8;
        _source_mystream_b_pat_stride_1 <= 1;
      end 
      if(_set_flag_18) begin
        _source_mystream_b_pat_size_2 <= 16;
        _source_mystream_b_pat_stride_2 <= 32;
      end 
      if(_set_flag_18) begin
      ...
      if(_set_flag_22) begin
        _sink_mystream_c_pat_size_0 <= 4;
        _sink_mystream_c_pat_stride_0 <= 8;
      end 
      if(_set_flag_22) begin
        _sink_mystream_c_pat_size_1 <= 8;
        _sink_mystream_c_pat_stride_1 <= 1;
      end 
      if(_set_flag_22) begin
        _sink_mystream_c_pat_size_2 <= 16;
        _sink_mystream_c_pat_stride_2 <= 32;
      end 
      if(_set_flag_22) begin
  ...
  always @(posedge CLK) begin
    if(RST) begin
      ...
      case(th_comp)
        ...
        th_comp_45: begin
          _th_comp_offset_stream_7 <= 0;
          _th_comp_offset_seq_8 <= _th_comp_offset_0;
          th_comp <= th_comp_46;
        end
        th_comp_46: begin
          _th_comp_all_ok_9 <= 1;
        ...
        th_comp_50: begin
          _th_comp_sq_11 <= _tmp_51;
          th_comp <= th_comp_51;
        end
        th_comp_51: begin
          if(_th_comp_st_10 !== _th_comp_sq_11) begin
            th_comp <= th_comp_52;
          end else begin
            th_comp <= th_comp_53;
          end
