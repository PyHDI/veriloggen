...
module test;
  ...
  reg signed [32-1:0] _th_ctrl_v_11;
  wire [32-1:0] _tmp_14;
  assign _tmp_14 = _th_ctrl_v_11;
  reg signed [32-1:0] _th_ctrl_awaddr_12;
  reg __saxi_cond_0_1;
  reg __saxi_cond_1_1;
  reg signed [32-1:0] _th_ctrl_araddr_13;
  reg __saxi_cond_2_1;
  reg signed [32-1:0] axim_rdata_15;
  reg __saxi_cond_3_1;
  reg signed [32-1:0] axim_rdata_16;
  reg __saxi_cond_4_1;
  assign _saxi_rready = (th_ctrl == 18) || (th_ctrl == 22) || (th_ctrl == 27);
  reg signed [32-1:0] axim_rdata_17;
  ...
  always @(posedge CLK) begin
    if(RST) begin
      ...
      if(th_ctrl == 10) begin
        _memory_mem[(_th_ctrl_i_10 << 2) + 0] <= _tmp_14[7:0];
      end 
      if(th_ctrl == 10) begin
        _memory_mem[(_th_ctrl_i_10 << 2) + 1] <= _tmp_14[15:8];
      end 
      if(th_ctrl == 10) begin
        _memory_mem[(_th_ctrl_i_10 << 2) + 2] <= _tmp_14[23:16];
      end 
      if(th_ctrl == 10) begin
        _memory_mem[(_th_ctrl_i_10 << 2) + 3] <= _tmp_14[31:24];
      end 
  ...
  always @(posedge CLK) begin
    if(RST) begin
      ...
      if((th_ctrl == 15) && (_saxi_wready || !_saxi_wvalid)) begin
        _saxi_wdata <= 1;
        _saxi_wvalid <= 1;
        _saxi_wstrb <= { 4{ 1'd1 } };
      end 
      ...
      if((th_ctrl == 17) && (_saxi_arready || !_saxi_arvalid)) begin
        _saxi_araddr <= _th_ctrl_araddr_13;
        _saxi_arvalid <= 1;
      end 
      __saxi_cond_2_1 <= 1;
      ...
      if((th_ctrl == 21) && (_saxi_arready || !_saxi_arvalid)) begin
        _saxi_araddr <= _th_ctrl_araddr_13;
        _saxi_arvalid <= 1;
      end 
      __saxi_cond_3_1 <= 1;
  ...
  always @(posedge CLK) begin
    if(RST) begin
      ...
      case(th_ctrl)
        ...
        th_ctrl_6: begin
          if(th_ctrl == 6) begin
            _tmp_13 <= { _memory_mem[(_th_ctrl_i_10 << 2) + 3], _memory_mem[(_th_ctrl_i_10 << 2) + 2], _memory_mem[(_th_ctrl_i_10 << 2) + 1], _memory_mem[(_th_ctrl_i_10 << 2) + 0] };
          end 
          th_ctrl <= th_ctrl_7;
        end
        th_ctrl_7: begin
          _th_ctrl_v_11 <= _tmp_13;
          th_ctrl <= th_ctrl_8;
        end
        th_ctrl_8: begin
          $display("read:  mem[%d] -> %x", _th_ctrl_i_10, _th_ctrl_v_11);
          th_ctrl <= th_ctrl_9;
        end
        th_ctrl_9: begin
          _th_ctrl_v_11 <= _th_ctrl_v_11 + 1024;
          th_ctrl <= th_ctrl_10;
        end
        th_ctrl_10: begin
          th_ctrl <= th_ctrl_11;
        ...
        th_ctrl_11: begin
          $display("write: mem[%d] <- %x", _th_ctrl_i_10, _th_ctrl_v_11);
          th_ctrl <= th_ctrl_12;
        end
        th_ctrl_12: begin
          _th_ctrl_i_10 <= _th_ctrl_i_10 + 1;
        ...
        th_ctrl_19: begin
          _th_ctrl_v_11 <= axim_rdata_15;
          th_ctrl <= th_ctrl_20;
        end
        th_ctrl_20: begin
          if(_th_ctrl_v_11 == 0) begin
            th_ctrl <= th_ctrl_21;
          end else begin
            th_ctrl <= th_ctrl_25;
          end
        ...
        th_ctrl_28: begin
          _th_ctrl_v_11 <= axim_rdata_17;
          th_ctrl <= th_ctrl_29;
        end
        th_ctrl_29: begin
          if(_th_ctrl_v_11) begin
            th_ctrl <= th_ctrl_30;
          end else begin
            th_ctrl <= th_ctrl_32;
          end
...
(
  ...
  wire _tmp_14;
  assign _tmp_14 = 1;
  localparam _tmp_15 = 1;
  wire [_tmp_15-1:0] _tmp_16;
  assign _tmp_16 = (_tmp_13 || !_tmp_11) && (_tmp_14 || !_tmp_12);
  reg [_tmp_15-1:0] __tmp_16_1;
  wire signed [32-1:0] _tmp_17;
  reg signed [32-1:0] __tmp_17_1;
  assign _tmp_17 = (__tmp_16_1)? myram_0_rdata : __tmp_17_1;
  reg _tmp_18;
  reg _tmp_19;
  reg _tmp_20;
  reg _tmp_21;
  ...
  assign __variable_ready_25 = (_myaxi_write_fsm == 3) && (_myaxi_write_op_sel == 1) && ((_tmp_23 > 0) && (myaxi_wready || !myaxi_wvalid));
  reg _myaxi_cond_1_1;
  assign _myaxi_write_data_done = (_tmp_24 && myaxi_wvalid && myaxi_wready)? 1 : 0;
  reg axim_flag_26;
  reg [32-1:0] _d1__myaxi_write_fsm;
  reg __myaxi_write_fsm_cond_4_0_1;
  reg _myram_cond_1_1;
  reg axim_flag_27;
  reg _th_blink_cond_28_1_1;
  reg axim_flag_28;
  ...
  assign __variable_ready_33 = (_tmp_31 > 0) && !_tmp_32;
  reg _myram_cond_2_1;
  reg [9-1:0] _tmp_34;
  reg _myaxi_cond_2_1;
  ...
  always @(posedge CLK) begin
    if(RST) begin
      ...
      if((_myaxi_write_fsm == 2) && ((myaxi_awready || !myaxi_awvalid) && (_tmp_23 == 0))) begin
        myaxi_awaddr <= _myaxi_write_cur_global_addr;
        myaxi_awlen <= _myaxi_write_cur_size - 1;
        myaxi_awvalid <= 1;
        _tmp_23 <= _myaxi_write_cur_size;
      end 
      if((_myaxi_write_fsm == 2) && ((myaxi_awready || !myaxi_awvalid) && (_tmp_23 == 0)) && (_myaxi_write_cur_size == 0)) begin
        myaxi_awvalid <= 0;
      end 
      _myaxi_cond_0_1 <= 1;
      ...
      if(__variable_valid_25 && ((_myaxi_write_fsm == 3) && (_myaxi_write_op_sel == 1) && ((_tmp_23 > 0) && (myaxi_wready || !myaxi_wvalid))) && ((_tmp_23 > 0) && (myaxi_wready || !myaxi_wvalid) && (_tmp_23 > 0))) begin
        myaxi_wdata <= __variable_data_25;
        myaxi_wvalid <= 1;
        myaxi_wlast <= 0;
        myaxi_wstrb <= { 4{ 1'd1 } };
        _tmp_23 <= _tmp_23 - 1;
      end 
      if(__variable_valid_25 && ((_myaxi_write_fsm == 3) && (_myaxi_write_op_sel == 1) && ((_tmp_23 > 0) && (myaxi_wready || !myaxi_wvalid))) && ((_tmp_23 > 0) && (myaxi_wready || !myaxi_wvalid) && (_tmp_23 > 0)) && (_tmp_23 == 1)) begin
        myaxi_wlast <= 1;
        _tmp_24 <= 1;
      end 
      _myaxi_cond_1_1 <= 1;
      ...
      if((_myaxi_read_fsm == 2) && ((myaxi_arready || !myaxi_arvalid) && (_tmp_34 == 0))) begin
        myaxi_araddr <= _myaxi_read_cur_global_addr;
        myaxi_arlen <= _myaxi_read_cur_size - 1;
        myaxi_arvalid <= 1;
        _tmp_34 <= _myaxi_read_cur_size;
      end 
      _myaxi_cond_2_1 <= 1;
      if(myaxi_arvalid && !myaxi_arready) begin
        myaxi_arvalid <= myaxi_arvalid;
      end 
      if(myaxi_rready && myaxi_rvalid && (_tmp_34 > 0)) begin
        _tmp_34 <= _tmp_34 - 1;
      end 
  ...
  assign __variable_data_33 = _wdata_29;
  assign __variable_valid_33 = _wvalid_30;
  ...
  always @(posedge CLK) begin
    if(RST) begin
      ...
      __tmp_16_1 <= _tmp_16;
      __tmp_17_1 <= _tmp_17;
      if((_tmp_13 || !_tmp_11) && (_tmp_14 || !_tmp_12) && _tmp_19) begin
        _tmp_21 <= 0;
        _tmp_11 <= 0;
        _tmp_12 <= 0;
        _tmp_19 <= 0;
      end 
      if((_tmp_13 || !_tmp_11) && (_tmp_14 || !_tmp_12) && _tmp_18) begin
        _tmp_11 <= 1;
        _tmp_12 <= 1;
        _tmp_21 <= _tmp_20;
        _tmp_20 <= 0;
      ...
      if(_myaxi_write_start && (_myaxi_write_op_sel == 1) && (_tmp_22 == 0) && !_tmp_20 && !_tmp_21) begin
        myram_0_addr <= _myaxi_write_local_addr;
        _tmp_22 <= _myaxi_write_size - 1;
        _tmp_18 <= 1;
        _tmp_20 <= _myaxi_write_size == 1;
      end 
      if((_tmp_13 || !_tmp_11) && (_tmp_14 || !_tmp_12) && (_tmp_22 > 0)) begin
        myram_0_addr <= myram_0_addr + _myaxi_write_local_stride;
        _tmp_22 <= _tmp_22 - 1;
        _tmp_18 <= 1;
        _tmp_20 <= 0;
      end 
      if((_tmp_13 || !_tmp_11) && (_tmp_14 || !_tmp_12) && (_tmp_22 == 1)) begin
        _tmp_20 <= 1;
      end 
      ...
      if(_myaxi_read_start && (_myaxi_read_op_sel == 1) && (_tmp_31 == 0)) begin
        myram_0_addr <= _myaxi_read_local_addr - _myaxi_read_local_stride;
        _tmp_31 <= _myaxi_read_size;
      end 
      if(__variable_valid_33 && ((_tmp_31 > 0) && !_tmp_32) && (_tmp_31 > 0)) begin
        myram_0_addr <= myram_0_addr + _myaxi_read_local_stride;
        myram_0_wdata <= __variable_data_33;
        myram_0_wenable <= 1;
        _tmp_31 <= _tmp_31 - 1;
      end 
      if(__variable_valid_33 && ((_tmp_31 > 0) && !_tmp_32) && (_tmp_31 == 1)) begin
        _tmp_32 <= 1;
      end 
      _myram_cond_2_1 <= 1;
      ...
      _myram_cond_3_1 <= th_blink == 42;
      _myram_cond_4_1 <= th_blink == 42;
      if(th_blink == 57) begin
        myram_0_addr <= _th_blink_i_5;
      end 
      _myram_cond_5_1 <= th_blink == 57;
      _myram_cond_6_1 <= th_blink == 57;
    end
  end

  assign __variable_data_25 = _tmp_17;
  assign __variable_valid_25 = _tmp_11;
  assign _tmp_13 = 1 && __variable_ready_25;
  ...
  always @(posedge CLK) begin
    if(RST) begin
      ...
      if((th_blink == 69) && (2 == 0)) begin
        _saxi_register_0 <= _tmp_9;
        _saxi_flag_0 <= 0;
      end 
      if((th_blink == 69) && (2 == 1)) begin
        _saxi_register_1 <= _tmp_9;
        _saxi_flag_1 <= 0;
      end 
      if((th_blink == 69) && (2 == 2)) begin
        _saxi_register_2 <= _tmp_9;
        _saxi_flag_2 <= 0;
      end 
      if((th_blink == 69) && (2 == 3)) begin
        _saxi_register_3 <= _tmp_9;
        _saxi_flag_3 <= 0;
      end 
      if((th_blink == 70) && (1 == 0)) begin
        _saxi_register_0 <= 1;
        _saxi_flag_0 <= 1;
        _saxi_resetval_0 <= 0;
      end 
      if((th_blink == 70) && (1 == 1)) begin
        _saxi_register_1 <= 1;
        _saxi_flag_1 <= 1;
        _saxi_resetval_1 <= 0;
      end 
      if((th_blink == 70) && (1 == 2)) begin
        _saxi_register_2 <= 1;
        _saxi_flag_2 <= 1;
        _saxi_resetval_2 <= 0;
      end 
      if((th_blink == 70) && (1 == 3)) begin
        _saxi_register_3 <= 1;
        _saxi_flag_3 <= 1;
        _saxi_resetval_3 <= 0;
      end 
  ...
  always @(posedge CLK) begin
    if(RST) begin
      ...
      _th_blink_gaddr_8 <= 0;
      axim_flag_10 <= 0;
      _th_blink_cond_16_0_1 <= 0;
      axim_flag_27 <= 0;
      _th_blink_cond_28_1_1 <= 0;
      axim_flag_28 <= 0;
      _th_blink_cond_35_2_1 <= 0;
      _tmp_37 <= 0;
      _th_blink_rdata_9 <= 0;
      axim_flag_38 <= 0;
      _th_blink_cond_50_3_1 <= 0;
      _tmp_40 <= 0;
    end else begin
      _d1_th_blink <= th_blink;
      case(_d1_th_blink)
        th_blink_16: begin
          if(_th_blink_cond_16_0_1) begin
            axim_flag_10 <= 0;
          end 
        end
        th_blink_28: begin
          if(_th_blink_cond_28_1_1) begin
            axim_flag_27 <= 0;
          end 
        end
        th_blink_35: begin
        ...
        th_blink_50: begin
          if(_th_blink_cond_50_3_1) begin
            axim_flag_38 <= 0;
          end 
        end
      endcase
...
def test():
    veriloggen.reset()
    test_module = thread_memorymodel_readwrite.mkTest()
