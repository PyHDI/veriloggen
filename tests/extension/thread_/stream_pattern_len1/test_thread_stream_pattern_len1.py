...
(
  ...
  reg [33-1:0] _source_mystream_a_pat_size_3;
  reg [32-1:0] _source_mystream_a_pat_stride_0;
  reg [32-1:0] _source_mystream_a_pat_stride_1;
  reg [32-1:0] _source_mystream_a_pat_stride_2;
  reg [32-1:0] _source_mystream_a_pat_stride_3;
  reg [33-1:0] _source_mystream_a_pat_count_0;
  reg [33-1:0] _source_mystream_a_pat_count_1;
  reg [33-1:0] _source_mystream_a_pat_count_2;
  reg [33-1:0] _source_mystream_a_pat_count_3;
  reg _set_flag_14;
  reg _tmp_15;
  reg _ram_a_cond_1_1;
  reg _ram_a_cond_2_1;
  ...
  reg [33-1:0] _source_mystream_b_pat_size_3;
  reg [32-1:0] _source_mystream_b_pat_stride_0;
  reg [32-1:0] _source_mystream_b_pat_stride_1;
  reg [32-1:0] _source_mystream_b_pat_stride_2;
  reg [32-1:0] _source_mystream_b_pat_stride_3;
  reg [33-1:0] _source_mystream_b_pat_count_0;
  reg [33-1:0] _source_mystream_b_pat_count_1;
  reg [33-1:0] _source_mystream_b_pat_count_2;
  reg [33-1:0] _source_mystream_b_pat_count_3;
  reg _set_flag_18;
  reg _tmp_19;
  reg _ram_b_cond_1_1;
  reg _ram_b_cond_2_1;
  ...
  reg [32-1:0] _sink_mystream_c_pat_offset_0;
  reg [32-1:0] _sink_mystream_c_pat_offset_1;
  reg [32-1:0] _sink_mystream_c_pat_offset_2;
  reg [32-1:0] _sink_mystream_c_pat_offset_3;
  reg [33-1:0] _sink_mystream_c_pat_size_0;
  reg [33-1:0] _sink_mystream_c_pat_size_1;
  reg [33-1:0] _sink_mystream_c_pat_size_2;
  reg [33-1:0] _sink_mystream_c_pat_size_3;
  reg [32-1:0] _sink_mystream_c_pat_stride_0;
  reg [32-1:0] _sink_mystream_c_pat_stride_1;
  reg [32-1:0] _sink_mystream_c_pat_stride_2;
  reg [32-1:0] _sink_mystream_c_pat_stride_3;
  reg [33-1:0] _sink_mystream_c_pat_count_0;
  reg [33-1:0] _sink_mystream_c_pat_count_1;
  reg [33-1:0] _sink_mystream_c_pat_count_2;
  reg [33-1:0] _sink_mystream_c_pat_count_3;
  reg _set_flag_22;
  reg _ram_c_cond_0_1;
  reg [32-1:0] _mystream_c_sink_pat_fsm_2;
  localparam _mystream_c_sink_pat_fsm_2_init = 0;
  wire [32-1:0] _mystream_c_sink_pat_all_offset;
  assign _mystream_c_sink_pat_all_offset = _mystream_c_sink_offset + _sink_mystream_c_pat_offset_0 + _sink_mystream_c_pat_offset_1 + _sink_mystream_c_pat_offset_2 + _sink_mystream_c_pat_offset_3;
  reg _set_flag_23;
  ...
  reg signed [32-1:0] _th_comp_sum_3;
  reg signed [32-1:0] _th_comp_i_4;
  reg _tmp_43;
  reg _ram_a_cond_3_1;
  reg _ram_a_cond_4_1;
  reg _ram_a_cond_4_2;
  reg signed [32-1:0] _tmp_44;
  reg signed [32-1:0] _th_comp_a_5;
  reg _tmp_45;
  reg _ram_b_cond_3_1;
  reg _ram_b_cond_4_1;
  reg _ram_b_cond_4_2;
  reg signed [32-1:0] _tmp_46;
  reg signed [32-1:0] _th_comp_b_6;
  reg _ram_c_cond_1_1;
  reg axim_flag_47;
  reg _th_comp_cond_41_5_1;
  reg signed [32-1:0] _th_comp_size_7;
  reg signed [32-1:0] _th_comp_offset_stream_8;
  reg signed [32-1:0] _th_comp_offset_seq_9;
  reg signed [32-1:0] _th_comp_all_ok_10;
  ...
  reg signed [32-1:0] _th_comp_st_12;
  reg _tmp_50;
  reg _ram_c_cond_4_1;
  reg _ram_c_cond_5_1;
  reg _ram_c_cond_5_2;
  reg signed [32-1:0] _tmp_51;
  reg signed [32-1:0] _th_comp_sq_13;
  ...
  always @(posedge CLK) begin
    if(RST) begin
      ...
      if(axim_flag_0) begin
        ...
        _myaxi_ram_a_0_read_local_addr <= _th_comp_offset_0;
        _myaxi_ram_a_0_read_global_addr <= 512;
        _myaxi_ram_a_0_read_size <= 1;
      ...
      if(axim_flag_8) begin
        ...
        _myaxi_ram_b_0_read_local_addr <= _th_comp_offset_0;
        _myaxi_ram_b_0_read_global_addr <= 512;
        _myaxi_ram_b_0_read_size <= 1;
      ...
      if(axim_flag_24) begin
        ...
        _myaxi_ram_c_0_write_local_addr <= _th_comp_offset_0;
  ...
  always @(posedge CLK) begin
    if(RST) begin
      ...
      if(th_comp == 34) begin
        ram_a_0_addr <= _th_comp_i_4 + _th_comp_offset_2;
      end 
  ...
  always @(posedge CLK) begin
    if(RST) begin
      ...
      if(th_comp == 36) begin
        ram_b_0_addr <= _th_comp_i_4 + _th_comp_offset_2;
      end 
  ...
  always @(posedge CLK) begin
    if(RST) begin
      ...
      if(th_comp == 39) begin
        ram_c_0_addr <= _th_comp_i_4 + _th_comp_offset_2;
        ram_c_0_wdata <= _th_comp_sum_3;
        ram_c_0_wenable <= 1;
      end 
      _ram_c_cond_1_1 <= th_comp == 39;
      if(th_comp == 49) begin
        ram_c_0_addr <= _th_comp_i_11 + _th_comp_offset_stream_8;
      end 
      _ram_c_cond_2_1 <= th_comp == 49;
      _ram_c_cond_3_1 <= th_comp == 49;
      if(th_comp == 51) begin
        ram_c_0_addr <= _th_comp_i_11 + _th_comp_offset_seq_9;
      end 
  ...
  always @(posedge CLK) begin
    if(RST) begin
      ...
      _source_mystream_a_pat_size_1 <= 0;
      _source_mystream_a_pat_stride_1 <= 0;
      _source_mystream_a_pat_size_2 <= 0;
      _source_mystream_a_pat_stride_2 <= 0;
      _source_mystream_a_pat_size_3 <= 0;
      _source_mystream_a_pat_stride_3 <= 0;
      ...
      _source_mystream_a_pat_count_3 <= 0;
      ...
      _source_mystream_b_pat_size_1 <= 0;
      _source_mystream_b_pat_stride_1 <= 0;
      _source_mystream_b_pat_size_2 <= 0;
      _source_mystream_b_pat_stride_2 <= 0;
      _source_mystream_b_pat_size_3 <= 0;
      _source_mystream_b_pat_stride_3 <= 0;
      ...
      _source_mystream_b_pat_count_3 <= 0;
      _mystream_b_source_ram_raddr <= 0;
      _mystream_b_source_ram_renable <= 0;
      _set_flag_22 <= 0;
      _mystream_c_sink_mode <= 0;
      _mystream_c_sink_offset <= 0;
      _sink_mystream_c_pat_size_0 <= 0;
      _sink_mystream_c_pat_stride_0 <= 0;
      _sink_mystream_c_pat_size_1 <= 0;
      _sink_mystream_c_pat_stride_1 <= 0;
      _sink_mystream_c_pat_size_2 <= 0;
      _sink_mystream_c_pat_stride_2 <= 0;
      _sink_mystream_c_pat_size_3 <= 0;
      _sink_mystream_c_pat_stride_3 <= 0;
      _mystream_c_sink_ram_sel <= 0;
      _mystream_c_sink_wenable <= 0;
      _mystream_c_sink_waddr <= 0;
      _sink_mystream_c_pat_offset_0 <= 0;
      _sink_mystream_c_pat_offset_1 <= 0;
      _sink_mystream_c_pat_offset_2 <= 0;
      _sink_mystream_c_pat_offset_3 <= 0;
      _sink_mystream_c_pat_count_0 <= 0;
      _sink_mystream_c_pat_count_1 <= 0;
      _sink_mystream_c_pat_count_2 <= 0;
      _sink_mystream_c_pat_count_3 <= 0;
      ...
      if(_set_flag_14) begin
        ...
        _mystream_a_source_offset <= _th_comp_offset_1;
      end 
      if(_set_flag_14) begin
        _source_mystream_a_pat_size_0 <= 1;
        _source_mystream_a_pat_stride_0 <= 1;
      end 
      if(_set_flag_14) begin
        _source_mystream_a_pat_size_1 <= 1;
        _source_mystream_a_pat_stride_1 <= 1;
      end 
      if(_set_flag_14) begin
        _source_mystream_a_pat_size_2 <= 1;
        _source_mystream_a_pat_stride_2 <= 1;
      end 
      if(_set_flag_14) begin
        _source_mystream_a_pat_size_3 <= 1;
        _source_mystream_a_pat_stride_3 <= 0;
      end 
      if(_set_flag_14) begin
      ...
      if(_mystream_a_source_pat_fsm_0 == 1) begin
        _mystream_a_source_ram_raddr <= _mystream_a_source_pat_all_offset;
      ...
      if(_set_flag_18) begin
        ...
        _mystream_b_source_offset <= _th_comp_offset_1;
      end 
      if(_set_flag_18) begin
        _source_mystream_b_pat_size_0 <= 1;
        _source_mystream_b_pat_stride_0 <= 1;
      end 
      if(_set_flag_18) begin
        _source_mystream_b_pat_size_1 <= 1;
        _source_mystream_b_pat_stride_1 <= 1;
      end 
      if(_set_flag_18) begin
        _source_mystream_b_pat_size_2 <= 1;
        _source_mystream_b_pat_stride_2 <= 1;
      end 
      if(_set_flag_18) begin
        _source_mystream_b_pat_size_3 <= 1;
        _source_mystream_b_pat_stride_3 <= 0;
      end 
      if(_set_flag_18) begin
      ...
      if(_mystream_b_source_pat_fsm_1 == 1) begin
        _mystream_b_source_ram_raddr <= _mystream_b_source_pat_all_offset;
      ...
      if(_set_flag_22) begin
        _mystream_c_sink_mode <= 1;
        _mystream_c_sink_offset <= _th_comp_offset_1;
      end 
      if(_set_flag_22) begin
        _sink_mystream_c_pat_size_0 <= 1;
        _sink_mystream_c_pat_stride_0 <= 1;
      end 
      if(_set_flag_22) begin
        _sink_mystream_c_pat_size_1 <= 1;
        _sink_mystream_c_pat_stride_1 <= 1;
      end 
      if(_set_flag_22) begin
        _sink_mystream_c_pat_size_2 <= 1;
        _sink_mystream_c_pat_stride_2 <= 1;
      end 
      if(_set_flag_22) begin
        _sink_mystream_c_pat_size_3 <= 1;
        _sink_mystream_c_pat_stride_3 <= 0;
      end 
      if(_set_flag_22) begin
        _mystream_c_sink_ram_sel <= 3;
      end 
      if(_mystream_c_sink_pat_fsm_2 == 0) begin
        _mystream_c_sink_wenable <= 0;
      end 
      if(_mystream_c_sink_pat_fsm_2 == 1) begin
      ...
      if(_mystream_c_sink_pat_fsm_2 == 1) begin
        _sink_mystream_c_pat_count_0 <= _sink_mystream_c_pat_size_0 - 1;
      end 
      if(_mystream_c_sink_pat_fsm_2 == 1) begin
        _sink_mystream_c_pat_count_1 <= _sink_mystream_c_pat_size_1 - 1;
      end 
      if(_mystream_c_sink_pat_fsm_2 == 1) begin
        _sink_mystream_c_pat_count_2 <= _sink_mystream_c_pat_size_2 - 1;
      end 
      if(_mystream_c_sink_pat_fsm_2 == 1) begin
        _sink_mystream_c_pat_count_3 <= _sink_mystream_c_pat_size_3 - 1;
      end 
      if(_mystream_c_sink_pat_fsm_2 == 6) begin
        _mystream_c_sink_wenable <= 0;
      end 
      if(_mystream_c_sink_pat_fsm_2 == 6) begin
        _mystream_c_sink_waddr <= _mystream_c_sink_pat_all_offset;
        _mystream_c_sink_wdata <= mystream_c_data;
        _mystream_c_sink_wenable <= 1;
      end 
      if(_mystream_c_sink_pat_fsm_2 == 6) begin
        _sink_mystream_c_pat_offset_0 <= _sink_mystream_c_pat_offset_0 + _sink_mystream_c_pat_stride_0;
        _sink_mystream_c_pat_count_0 <= _sink_mystream_c_pat_count_0 - 1;
      end 
      if((_mystream_c_sink_pat_fsm_2 == 6) && (_sink_mystream_c_pat_count_0 == 0)) begin
        _sink_mystream_c_pat_offset_0 <= 0;
        _sink_mystream_c_pat_count_0 <= _sink_mystream_c_pat_size_0 - 1;
      end 
      if((_mystream_c_sink_pat_fsm_2 == 6) && (_sink_mystream_c_pat_count_0 == 0)) begin
        _sink_mystream_c_pat_offset_1 <= _sink_mystream_c_pat_offset_1 + _sink_mystream_c_pat_stride_1;
        _sink_mystream_c_pat_count_1 <= _sink_mystream_c_pat_count_1 - 1;
      end 
      if((_mystream_c_sink_pat_fsm_2 == 6) && (_sink_mystream_c_pat_count_0 == 0) && (_sink_mystream_c_pat_count_1 == 0)) begin
        _sink_mystream_c_pat_offset_1 <= 0;
        _sink_mystream_c_pat_count_1 <= _sink_mystream_c_pat_size_1 - 1;
      end 
      if((_mystream_c_sink_pat_fsm_2 == 6) && ((_sink_mystream_c_pat_count_0 == 0) && (_sink_mystream_c_pat_count_1 == 0))) begin
        _sink_mystream_c_pat_offset_2 <= _sink_mystream_c_pat_offset_2 + _sink_mystream_c_pat_stride_2;
        _sink_mystream_c_pat_count_2 <= _sink_mystream_c_pat_count_2 - 1;
      end 
      if((_mystream_c_sink_pat_fsm_2 == 6) && ((_sink_mystream_c_pat_count_0 == 0) && (_sink_mystream_c_pat_count_1 == 0)) && (_sink_mystream_c_pat_count_2 == 0)) begin
        _sink_mystream_c_pat_offset_2 <= 0;
        _sink_mystream_c_pat_count_2 <= _sink_mystream_c_pat_size_2 - 1;
      end 
      if((_mystream_c_sink_pat_fsm_2 == 6) && ((_sink_mystream_c_pat_count_0 == 0) && (_sink_mystream_c_pat_count_1 == 0) && (_sink_mystream_c_pat_count_2 == 0))) begin
        _sink_mystream_c_pat_offset_3 <= _sink_mystream_c_pat_offset_3 + _sink_mystream_c_pat_stride_3;
        _sink_mystream_c_pat_count_3 <= _sink_mystream_c_pat_count_3 - 1;
      end 
      if((_mystream_c_sink_pat_fsm_2 == 6) && ((_sink_mystream_c_pat_count_0 == 0) && (_sink_mystream_c_pat_count_1 == 0) && (_sink_mystream_c_pat_count_2 == 0)) && (_sink_mystream_c_pat_count_3 == 0)) begin
        _sink_mystream_c_pat_offset_3 <= 0;
        _sink_mystream_c_pat_count_3 <= _sink_mystream_c_pat_size_3 - 1;
      end 
      _set_flag_23 <= 0;
  ...
  always @(posedge CLK) begin
    if(RST) begin
      ...
      _th_comp_size_7 <= 0;
      _th_comp_offset_stream_8 <= 0;
      _th_comp_offset_seq_9 <= 0;
      _th_comp_all_ok_10 <= 0;
      _th_comp_i_11 <= 0;
      _tmp_49 <= 0;
      _th_comp_st_12 <= 0;
      _tmp_51 <= 0;
      ...
      case(th_comp)
        ...
        th_comp_37: begin
          _th_comp_b_6 <= _tmp_46;
          th_comp <= th_comp_38;
        end
        th_comp_38: begin
          _th_comp_sum_3 <= _th_comp_a_5 + _th_comp_b_6;
          th_comp <= th_comp_39;
        end
        th_comp_39: begin
          th_comp <= th_comp_40;
        ...
        th_comp_45: begin
          _th_comp_size_7 <= 1;
          _th_comp_offset_stream_8 <= 0;
          _th_comp_offset_seq_9 <= _th_comp_offset_0;
          th_comp <= th_comp_46;
        end
        th_comp_46: begin
          _th_comp_all_ok_10 <= 1;
          th_comp <= th_comp_47;
        end
        th_comp_47: begin
          _th_comp_i_11 <= 0;
        ...
        th_comp_52: begin
          _th_comp_sq_13 <= _tmp_51;
          th_comp <= th_comp_53;
        end
        th_comp_53: begin
          if(_th_comp_st_12 !== _th_comp_sq_13) begin
            th_comp <= th_comp_54;
          end else begin
            th_comp <= th_comp_55;
          end
  ...
  localparam _mystream_a_source_pat_fsm_0_1 = 1;
  localparam _mystream_a_source_pat_fsm_0_2 = 2;

  always @(posedge CLK) begin
    if(RST) begin
      _mystream_a_source_pat_fsm_0 <= _mystream_a_source_pat_fsm_0_init;
    end else begin
      case(_mystream_a_source_pat_fsm_0)
        ...
        _mystream_a_source_pat_fsm_0_1: begin
          if((_source_mystream_a_pat_count_0 == 0) && (_source_mystream_a_pat_count_1 == 0) && (_source_mystream_a_pat_count_2 == 0) && (_source_mystream_a_pat_count_3 == 0)) begin
            _mystream_a_source_pat_fsm_0 <= _mystream_a_source_pat_fsm_0_2;
          end 
        end
        _mystream_a_source_pat_fsm_0_2: begin
          _mystream_a_source_pat_fsm_0 <= _mystream_a_source_pat_fsm_0_init;
        end
      endcase
    end
  ...
  localparam _mystream_b_source_pat_fsm_1_1 = 1;
  localparam _mystream_b_source_pat_fsm_1_2 = 2;

  always @(posedge CLK) begin
    if(RST) begin
      _mystream_b_source_pat_fsm_1 <= _mystream_b_source_pat_fsm_1_init;
    end else begin
      case(_mystream_b_source_pat_fsm_1)
        ...
        _mystream_b_source_pat_fsm_1_1: begin
          if((_source_mystream_b_pat_count_0 == 0) && (_source_mystream_b_pat_count_1 == 0) && (_source_mystream_b_pat_count_2 == 0) && (_source_mystream_b_pat_count_3 == 0)) begin
            _mystream_b_source_pat_fsm_1 <= _mystream_b_source_pat_fsm_1_2;
          end 
        end
        _mystream_b_source_pat_fsm_1_2: begin
          _mystream_b_source_pat_fsm_1 <= _mystream_b_source_pat_fsm_1_init;
        end
      endcase
    end
  ...
  localparam _mystream_c_sink_pat_fsm_2_1 = 1;
  localparam _mystream_c_sink_pat_fsm_2_2 = 2;
  localparam _mystream_c_sink_pat_fsm_2_3 = 3;
  localparam _mystream_c_sink_pat_fsm_2_4 = 4;
  localparam _mystream_c_sink_pat_fsm_2_5 = 5;
  localparam _mystream_c_sink_pat_fsm_2_6 = 6;

  always @(posedge CLK) begin
    if(RST) begin
      _mystream_c_sink_pat_fsm_2 <= _mystream_c_sink_pat_fsm_2_init;
    end else begin
      case(_mystream_c_sink_pat_fsm_2)
        _mystream_c_sink_pat_fsm_2_init: begin
          if(_mystream_start && (_mystream_c_sink_mode == 1) && (_sink_mystream_c_pat_size_0 > 0) && (_sink_mystream_c_pat_size_1 > 0) && (_sink_mystream_c_pat_size_2 > 0) && (_sink_mystream_c_pat_size_3 > 0)) begin
            _mystream_c_sink_pat_fsm_2 <= _mystream_c_sink_pat_fsm_2_1;
          end 
        end
        _mystream_c_sink_pat_fsm_2_1: begin
          _mystream_c_sink_pat_fsm_2 <= _mystream_c_sink_pat_fsm_2_2;
        end
        _mystream_c_sink_pat_fsm_2_2: begin
          _mystream_c_sink_pat_fsm_2 <= _mystream_c_sink_pat_fsm_2_3;
        end
        _mystream_c_sink_pat_fsm_2_3: begin
          _mystream_c_sink_pat_fsm_2 <= _mystream_c_sink_pat_fsm_2_4;
        end
        _mystream_c_sink_pat_fsm_2_4: begin
          _mystream_c_sink_pat_fsm_2 <= _mystream_c_sink_pat_fsm_2_5;
        end
        _mystream_c_sink_pat_fsm_2_5: begin
          _mystream_c_sink_pat_fsm_2 <= _mystream_c_sink_pat_fsm_2_6;
        end
        _mystream_c_sink_pat_fsm_2_6: begin
          if((_sink_mystream_c_pat_count_0 == 0) && (_sink_mystream_c_pat_count_1 == 0) && (_sink_mystream_c_pat_count_2 == 0) && (_sink_mystream_c_pat_count_3 == 0)) begin
            _mystream_c_sink_pat_fsm_2 <= _mystream_c_sink_pat_fsm_2_init;
          end 
        end
      endcase
...
def test():
    veriloggen.reset()
    test_module = thread_stream_pattern_len1.mkTest()
