...
(
  ...
  wire signed [32-1:0] _tmp_117;
  reg signed [32-1:0] __tmp_117_1;
  ...
  assign _plus_data_52 = _plus_data_131;
  assign _plus_valid_52 = _plus_valid_131;
  assign _plus_ready_131 = _plus_ready_52;
...
def test():
    veriloggen.reset()
    test_module = thread_stream_len1.mkTest()
