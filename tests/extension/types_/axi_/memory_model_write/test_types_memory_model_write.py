...
(
  ...
  always @(posedge CLK) begin
    if(RST) begin
      ...
      if((fsm == 1) && ((counter_1 > 0) && (myaxi_wready || !myaxi_wvalid) && (counter_1 > 0))) begin
        myaxi_wdata <= wdata;
        myaxi_wvalid <= 1;
        myaxi_wlast <= 0;
        myaxi_wstrb <= { 4{ 1'd1 } };
      ...
      if((fsm == 1) && ((counter_1 > 0) && (myaxi_wready || !myaxi_wvalid) && (counter_1 > 0)) && (counter_1 == 1)) begin
        myaxi_wlast <= 1;
        last_2 <= 1;
      end 
      _myaxi_cond_1_1 <= 1;
      ...
      if((fsm == 2) && ((myaxi_awready || !myaxi_awvalid) && (counter_3 == 0))) begin
        myaxi_awaddr <= 1024;
        myaxi_awlen <= 63;
        myaxi_awvalid <= 1;
        counter_3 <= 64;
      end 
      if((fsm == 2) && ((myaxi_awready || !myaxi_awvalid) && (counter_3 == 0)) && 0) begin
        myaxi_awvalid <= 0;
      end 
      _myaxi_cond_2_1 <= 1;
      if(myaxi_awvalid && !myaxi_awready) begin
      ...
      if((fsm == 3) && ((counter_3 > 0) && (myaxi_wready || !myaxi_wvalid) && (counter_3 > 0))) begin
        myaxi_wdata <= wdata;
        myaxi_wvalid <= 1;
        myaxi_wlast <= 0;
        myaxi_wstrb <= { 4{ 1'd1 } };
      ...
      if((fsm == 3) && ((counter_3 > 0) && (myaxi_wready || !myaxi_wvalid) && (counter_3 > 0)) && (counter_3 == 1)) begin
        myaxi_wlast <= 1;
        last_4 <= 1;
      end 
      _myaxi_cond_3_1 <= 1;
  ...
  always @(posedge CLK) begin
    if(RST) begin
      ...
      case(fsm)
        ...
        fsm_3: begin
          if((counter_3 > 0) && (myaxi_wready || !myaxi_wvalid)) begin
            wdata <= wdata + 1;
          end 
          if(last_4) begin
            fsm <= fsm_4;
