...
(
  ...
  assign rx = ((_pipe_ready_0 || (!_pipe_valid_0)) && (_pipe_ready_0 || (!_pipe_valid_0)));
  assign ry = ((_pipe_ready_0 || (!_pipe_valid_0)) && (_pipe_ready_0 || (!_pipe_valid_0)));
  ...
  always @(posedge CLK) begin
    if(RST) begin
      ...
      if((((((vx && rx) && (vy && ry)) && (vx && rx)) && (vy && ry)) && (_pipe_ready_0 || (!_pipe_valid_0)))) begin
        _pipe_data_0 <= (((x > y))? x : y);
      end 
      if(_pipe_ready_0 || !_pipe_valid_0) begin
        _pipe_valid_0 <= ((((vx && rx) && (vy && ry)) && (vx && rx)) && (vy && ry));
      end 
...
def test():
    test_module = lib_dataflow_select.mkTest()
