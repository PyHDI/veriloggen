...
module blinkled
  ...
  always @(posedge CLK) begin
    if(RST) begin
      ...
      _par_cond_2_1 <= (count == 1);
      if(count == 2) begin
        led2 <= 1;
      end 
      _par_cond_3_1 <= (count == 2);
      if(count == 3) begin
        led3 <= 1;
      end 
      _par_cond_4_1 <= (count == 3);
      if(count == 4) begin
        led4 <= 1;
      end 
      _par_cond_5_1 <= (count == 4);
      if(count == 5) begin
        led5 <= 1;
      end 
      _par_cond_6_1 <= (count == 5);
      if(count == 6) begin
        led6 <= 1;
      end 
      _par_cond_7_1 <= (count == 6);
      if(count == 7) begin
        led7 <= 1;
      end 
      _par_cond_8_1 <= (count == 7);
    end
  end
