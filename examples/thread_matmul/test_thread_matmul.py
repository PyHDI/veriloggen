...
(
  ...
  reg _myaxi_cond_3_1;
  reg signed [32-1:0] _th_matmul_matrix_size_17;
  reg signed [32-1:0] _th_matmul_a_offset_18;
  reg signed [32-1:0] _th_matmul_b_offset_19;
  reg signed [32-1:0] _th_matmul_c_offset_20;
  reg signed [32-1:0] _th_matmul_all_ok_21;
  reg signed [32-1:0] _th_matmul_c_addr_22;
  reg signed [32-1:0] _th_matmul_i_23;
  reg [10-1:0] _tmp_43;
  reg [32-1:0] _tmp_44;
  reg [32-1:0] _tmp_45;
  reg [32-1:0] _tmp_46;
  ...
  reg _ram_c_cond_1_1;
  reg signed [32-1:0] _th_matmul_j_24;
  reg _tmp_53;
  reg _ram_c_cond_2_1;
  reg _ram_c_cond_3_1;
  reg _ram_c_cond_3_2;
  reg signed [32-1:0] _tmp_54;
  reg signed [32-1:0] _th_matmul_v_25;
  ...
  always @(posedge CLK) begin
    if(RST) begin
      ...
      _ram_a_cond_1_1 <= th_matmul == 17;
      _ram_a_cond_2_1 <= th_matmul == 17;
    end
  end
  ...
  always @(posedge CLK) begin
    if(RST) begin
      ...
      _ram_b_cond_1_1 <= th_matmul == 19;
      _ram_b_cond_2_1 <= th_matmul == 19;
    end
  end
  ...
  always @(posedge CLK) begin
    if(RST) begin
      ...
      _tmp_27 <= 0;
      _tmp_26 <= 0;
      _th_matmul_matrix_size_17 <= 0;
      _th_matmul_a_offset_18 <= 0;
      _th_matmul_b_offset_19 <= 0;
      _th_matmul_c_offset_20 <= 0;
      _th_matmul_all_ok_21 <= 0;
      _th_matmul_c_addr_22 <= 0;
      _th_matmul_i_23 <= 0;
      _tmp_43 <= 0;
      _tmp_44 <= 0;
      _tmp_46 <= 0;
      ...
      case(th_matmul)
        ...
        th_matmul_5: begin
          _tmp_0 <= 0;
          _tmp_1 <= _th_matmul_a_addr_8;
          _tmp_3 <= _th_matmul_matrix_size_4;
        ...
        th_matmul_11: begin
          _tmp_10 <= 0;
          _tmp_11 <= _th_matmul_b_addr_11;
          _tmp_13 <= _th_matmul_matrix_size_4;
        ...
        th_matmul_26: begin
          _tmp_24 <= 0;
          _tmp_25 <= _th_matmul_c_addr_9;
          _tmp_27 <= _th_matmul_matrix_size_4;
        ...
        th_matmul_32: begin
          _th_matmul_matrix_size_17 <= _th_matmul_matrix_size_0;
          _th_matmul_a_offset_18 <= _th_matmul_a_offset_1;
          _th_matmul_b_offset_19 <= _th_matmul_b_offset_2;
          _th_matmul_c_offset_20 <= _th_matmul_c_offset_3;
          th_matmul <= th_matmul_33;
        end
        th_matmul_33: begin
          _th_matmul_all_ok_21 <= 1;
          th_matmul <= th_matmul_34;
        end
        th_matmul_34: begin
          _th_matmul_c_addr_22 <= _th_matmul_c_offset_20;
        ...
        th_matmul_36: begin
          if(_th_matmul_i_23 < _th_matmul_matrix_size_17) begin
        ...
        th_matmul_37: begin
          _tmp_43 <= 0;
          _tmp_44 <= _th_matmul_c_addr_22;
          _tmp_46 <= _th_matmul_matrix_size_17;
        ...
        th_matmul_41: begin
          if(_th_matmul_j_24 < _th_matmul_matrix_size_17) begin
        ...
        th_matmul_43: begin
          _th_matmul_v_25 <= _tmp_54;
          th_matmul <= th_matmul_44;
        end
        th_matmul_44: begin
          if((_th_matmul_i_23 == _th_matmul_j_24) && (_th_matmul_v_25 != (_th_matmul_i_23 + 1 << 1))) begin
        ...
        th_matmul_46: begin
          if((_th_matmul_i_23 != _th_matmul_j_24) && (_th_matmul_v_25 != 0)) begin
        ...
        th_matmul_48: begin
          _th_matmul_j_24 <= _th_matmul_j_24 + 1;
          th_matmul <= th_matmul_41;
        end
        th_matmul_49: begin
          _th_matmul_c_addr_22 <= _th_matmul_c_addr_22 + (_th_matmul_matrix_size_17 << 2);
          th_matmul <= th_matmul_50;
        end
        th_matmul_50: begin
          _th_matmul_i_23 <= _th_matmul_i_23 + 1;
          th_matmul <= th_matmul_36;
        end
        th_matmul_51: begin
          if(_th_matmul_all_ok_21) begin
