...
(
  ...
  wire signed [32-1:0] _dataflow_divide_data_2;
  wire _dataflow_divide_valid_2;
  wire _dataflow_divide_ready_2;
  reg signed [32-1:0] _dataflow_divide_div_ldata_2;
  reg signed [32-1:0] _dataflow_divide_div_rdata_2;
  reg [32-1:0] _dataflow_divide_div_abs_ldata_2;
  reg [32-1:0] _dataflow_divide_div_abs_rdata_2;
  wire _dataflow_divide_div_osign_2;
  wire signed [32-1:0] _dataflow_divide_div_abs_odata_2;
  reg signed [32-1:0] _dataflow_divide_div_odata_2;
  ...
  reg signed [32-1:0] _dataflow__delay_data_4;
  ...
  reg signed [32-1:0] _dataflow__delay_data_5;
  ...
  reg signed [32-1:0] _dataflow__delay_data_13;
  ...
  reg signed [32-1:0] _dataflow__delay_data_14;
  ...
  reg signed [32-1:0] _dataflow_plus_data_3;
  ...
  always @(posedge CLK) begin
    if(RST) begin
      ...
      if(_dataflow_divide_ready_2 || !_dataflow_divide_valid_2) begin
        _dataflow_divide_div_abs_ldata_2 <= (_dataflow_divide_div_ldata_2[31] == 0)? _dataflow_divide_div_ldata_2 : ~_dataflow_divide_div_ldata_2 + 1;
      end 
      if(_dataflow_divide_ready_2 || !_dataflow_divide_valid_2) begin
        _dataflow_divide_div_abs_rdata_2 <= (_dataflow_divide_div_rdata_2[31] == 0)? _dataflow_divide_div_rdata_2 : ~_dataflow_divide_div_rdata_2 + 1;
      end 
      if(_dataflow_divide_ready_2 || !_dataflow_divide_valid_2) begin
        _dataflow_divide_div_odata_2 <= (_dataflow_divide_div_osign_2 == 0)? _dataflow_divide_div_abs_odata_2 : ~_dataflow_divide_div_abs_odata_2 + 1;
      end 
      if(_dataflow_divide_ready_2 || !_dataflow_divide_valid_2) begin
